...
class Client_api_keys extends CI_Controller
{
    ...
    {
        if (isset($_POST['edit_client_api_keys']) && !empty($_POST['edit_client_api_keys'])) {
        ...
        if (!$this->form_validation->run()) {
            ...
            $message = (isset($_POST['edit_client_api_keys']) && !empty($_POST['edit_client_api_keys'])) ? ' Client Updated Successfully' : 'Client Added Successfully';
    ...
    public function delete_client()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (delete_details(['id' => $_GET['id']], 'client_api_keys')) {
                ...
                $this->response['message'] = 'Client API Key Deleted Succesfully';
