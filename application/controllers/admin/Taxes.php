...
class Taxes extends CI_Controller
{
    ...
    public function add_tax()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $this->form_validation->set_rules('percentage', 'Percentage', 'trim|required|numeric|xss_clean|less_than_equal_to[100]|greater_than_equal_to[1]');
            ...
            if (!$this->form_validation->run()) {
                ...
                $message = (isset($_POST['edit_tax_id']) && !empty($_POST['edit_tax_id'])) ? 'Tax Details Updated Successfully' : 'Tax Details Added Successfully';
