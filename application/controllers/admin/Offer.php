...
class Offer extends CI_Controller
{
    ...
    public function add_offer()
    {
        ...
        if (!$this->form_validation->run()) {
            ...
            $message = (isset($_POST['edit_offer']) && !empty($_POST['edit_offer'])) ? 'Offer Update Successfully' : 'Offer Added Successfully';
    ...
    public function view_offers()
    {
        ...
        return $this->Offer_model->get_offer_list($type_filter);
    }
