    ...
    public function update_payment_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (
                ...
                sendWebJsonResponse(true, 'Please select at least one payment method.');
            }
            ...
            if (isset($_POST['myfaoorah_payment_method']) && !empty($_POST['myfaoorah_payment_method'])) {
                ...
                $this->form_validation->set_rules('myfatoorah_secret_key', 'myfatoorah Secret Key', 'trim|required|xss_clean');
            }
            ...
            if (!$this->form_validation->run()) {
                ...
                $fields = [
                    ...
                    'flutterwave_webhook_secret_key',
                ...
                sendWebJsonResponse(false, 'Payment Setting Updated Successfully');
            }
        } else {
            redirect('admin/login', 'refresh');
        }
