                ...
                if (!empty($order_id)) {
                    ...
                    if (strpos($order_id, "wallet-refill-user") !== false) {
                        ...
                        if (isset($order['order_data'][0]['user_id'])) {
                            ...
                            $product_variant_ids = [];
                            $quantity = [];
                            foreach ($order['order_data'][0] as $item) {
                                $product_variant_ids[] = $item['order_items']['product_variant_id'];
                                $quantity[] = $item['order_items']['quantity'];
                            }

                            update_stock($order['order_data'][0]['product_variant_ids'], $order['order_data'][0]['quantity'], 'minus');
                        }
                    }
                } else {
