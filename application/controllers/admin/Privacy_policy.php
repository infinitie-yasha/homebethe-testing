...
class Privacy_policy extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            $this->data['main_page'] = VIEW . 'policies';
            $settings = get_settings('system_settings', true);
            $this->data['title'] = 'Policies | ' . $settings['app_name'];
            $this->data['meta_description'] = 'Policies | ' . $settings['app_name'];
    ...
    public function update_privacy_policy_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                // print_r($privacy_policy_input_description);
                // die();
                ...
                sendWebJsonResponse(false, 'Privacy Policy Setting Updated Successfully');
            }
        } else {
            redirect('admin/login', 'refresh');
        }
    ...
    public function update_shipping_policy_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                sendWebJsonResponse(false, 'Shipping Policy Updated Successfully');
    ...
    public function update_return_policy_settings()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                sendWebJsonResponse(false, 'Return Policy Setting Updated Successfully');
