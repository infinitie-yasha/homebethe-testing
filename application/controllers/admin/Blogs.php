        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                if (isset($edit_category) && !empty($edit_category)) {
                    if (is_exist(['name' => $category_input_name], 'blog_categories', $edit_category)) {
                        sendWebJsonResponse(true, " Category Already exist you should use a different name");
                    }
                } else {
                    if (is_exist(['name' => $category_input_name], 'blog_categories')) {
                        sendWebJsonResponse(true, " Category Already exist you should use a different name");
                    }
                }
                ...
                $message = (isset($_POST['edit_category']) && !empty($_POST['edit_category'])) ? 'Category Updated Successfully' : 'Category Added Successfully';
    ...
    public function delete_category()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (delete_details(['id' => $_GET['id']], 'blog_categories') == TRUE) {
                ...
                $this->response['message'] = 'Blog Category Deleted Successfully';
            } else {
    ...
    public function add_blog()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                $message = (isset($_POST['edit_blog']) && !empty($_POST['edit_blog'])) ? 'Blog Updated Successfully' : 'Blog Added Successfully';
