...
class Notification_settings extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $this->data['title'] = ' Notification Settings | ' . $settings['app_name'];
    ...
    public function send_notifications()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (empty($res)) {
                ...
                sendWebJsonResponse(true, 'There is no users to send notification.', [], $this->response);
            }
            ...
            sendWebJsonResponse(false, 'Notification Sended Successfully');
        } else {
            redirect('admin/login', 'refresh');
        }
    }
