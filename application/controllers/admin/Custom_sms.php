    ...
    public function add_sms()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                if (isset($_POST['edit_custom_sms']) && !empty($_POST['edit_custom_sms'])) {
                    if (is_exist(['type' => $_POST['type']], 'custom_sms', $_POST['edit_custom_sms'])) {
                        sendWebJsonResponse(true, 'you allrady have same type ! Provide a unique type');
                    }
                } else {
                ...
                $message = (isset($_POST['edit_custom_sms']) && !empty($_POST['edit_custom_sms'])) ? 'SMS Updated Successfully' : 'SMS Added Successfully';
