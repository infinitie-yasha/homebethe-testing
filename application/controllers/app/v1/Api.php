...
*/
    ...
    protected $excluded_routes =
        [
            ...
            "app/v1/api/flutterwave-payment-response",
  ...
  */
        ...
        if (!$this->form_validation->run()) {
            ...
            if (!empty($res)) {
                ...
                for ($i = 0; $i < count($res); $i++) {
                    ...
                    if (!empty($pro_details) && !empty($pro_details['product'][0])) {
        ...
        */
        ...
        if (!$this->form_validation->run()) {
            ...
            if (strpos($order_id, "wallet-refill-user") !== false) {
                ...
                $order_id = "order" . "-" . $order_id . "-" . time() . "-" . rand(1000, 9999);
            }
    ...
    public function get_product_faqs()
    {
        ...
        */
        ...
        if (!$this->form_validation->run()) {
            ...
            $result = $this->product_model->get_product_faqs($id, $product_id, $user_id, $search, $offset, $limit, $sort, $order, from_app: true);
            print_r(json_encode($result));
        }
    }
    ...
    public function flutterwave_webhook()
    {
        ...
        log_message('error', 'Flutterwave Webhook transaction --> ' . var_export($transaction, true));
            ...
            if ((isset($event->data->id) && !empty($event->data->id)) || (isset($event->id) && !empty($event->id))) {
                ...
                if (!empty($txn_id)) {
                    ...
                    if (isset($temp_order_id[1]) && is_numeric($temp_order_id[1]) && !empty($temp_order_id[1] && $temp_order_id[1] != '')) {
                        ...
                        if (strpos($txn_id, "wallet-refill-user") !== false) {
