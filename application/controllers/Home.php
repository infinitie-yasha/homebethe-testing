...
namespace Ci3\controllers;

use Ci3\libraries\Test;
use CodeIgniter3\System\Core\CI_Controller;
...
class Home extends CI_Controller
{
    ...
    public function send_contact_us_email()
    {
        ...
        // );
        $email_message = '
            Hello, Dear <b>' . ucfirst($username) . '</b>, <br><br>
            Subject: ' . $subject . '<br>
            Email: ' . $email . '<br><br>
        ...
        $mail = send_mail($to,  $subject, $email_message);
        if ($mail['error'] == true) {
            $this->response['error'] = true;
