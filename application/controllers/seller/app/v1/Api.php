...
*/
    ...
    protected $excluded_routes =
        [
            ...
            "seller/app/v1/api/get_available_payment_gateways",
        ];
    ...
    public function login()
    {
        ...
        */
        ...
        $user = $this->db->where(['mobile' => $this->input->post('mobile', true)])->get('users')->result_array();

        if ($_POST['type_otp']) {
            $login = (!empty($user)) ? true : false;
        }
    ...
    */
    ...
    function get_available_payment_gateways(): array
    {
