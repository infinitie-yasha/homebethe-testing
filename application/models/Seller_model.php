...
class Seller_model extends CI_Model
{
    ...
    function add_seller($data, $profile = [], $com_data = [])
    {
        ...
        $seller_data = [
            ...
            "withdrawal_payment_gateway" => (isset($data['withdrawal_payment_gateway']) && !empty($data['withdrawal_payment_gateway'])) ? $data['withdrawal_payment_gateway'] : null,
            ...
            // 'category_ids' => (isset($data['categories']) && $data['categories'] != "") ? implode(",", $data['categories'])  : null,
            'category_ids' => (
    ...
    function get_sellers_list($get_sellers_list = "")
    {
        ...
        foreach ($offer_search_res as $row) {
            ...
            $tempRow['logo'] = '<div class="mx-auto product-image image-box-table"><a href=' . $row['logo_img'] . ' data-toggle="lightbox" data-gallery="gallery"><img src=' . $row['logo_img'] . ' class="rounded"></a></div>';
