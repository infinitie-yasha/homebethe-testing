        ...
        foreach ($user_details as $row) {
            ...
            if ($this->ion_auth->is_delivery_boy()) {
                ...
                if ($row['download_allowed'] == 0 && $row['type'] == 'digital_product') {
                    $operate .= '<a href="javascript:void(0)" class="sendMailBtn btn action-btn btn-primary btn-xs mr-1 mb-1 ml-1" data-bs-target="#ManageOrderSendMailModal" data-bs-toggle="modal" title="Edit" data-email="' . $row['email'] . '" data-id="' . $row['order_item_id'] . '" data-url="seller/orders/"><i class="fas fa-paper-plane"></i></a>';
                ...
                if ($row['download_allowed'] == 0 && $row['type'] == 'digital_product') {
                    ...
                    $operate .= '<a href="javascript:void(0)" class="btn sendMailBtn action-btn btn-primary bg-primary-lt btn-sm mx-1" data-bs-target="#ManageOrderSendMailModal" data-bs-toggle="modal" title="Edit" data-email="' . $row['email'] . '" data-id="' . $row['order_item_id'] . '" data-url="admin/orders/"><i class="ti ti-send fs-3"></i></a>';
        ...
        <a href="' . base_url('seller/orders/edit_orders') . '?edit_id=' . $row['order_id'] . '" class="dropdown-item">
            <i class="ti ti-pencil me-2"></i>Edit Order
                ...
                if ($row['download_allowed'] == 0 && $row['type'] == 'digital_product') {
                    // Send Mail
                    $operate .= '<li>
        <a href="javascript:void(0)" class="dropdown-item sendMailBtn" data-bs-toggle="offcanvas" data-bs-target="#ManageOrderSendMailModal" data-email="' . $row['email'] . '" data-id="' . $row['order_item_id'] . '" data-url="seller/orders/">
        ...
        <a href="javascript:void(0)" class="dropdown-item" data-order_id="' . $row['order_id'] . '" data-order_item_id="' . $row['order_item_id'] . '" data-seller_id="' . $row['seller_id'] . '" data-courier_agency="' . $row['courier_agency'] . '" data-tracking_id="' . $row['tracking_id'] . '" data-url="' . $row['url'] . '" data-bs-toggle="offcanvas" data-bs-target="#order_tracking_offcanvas">
            <i class="ti ti-map-pin me-2"></i>Order Tracking
                ...
                if ($row['download_allowed'] == 0 && $row['type'] == 'digital_product') {
                    // Send Mail
                    $operate .= '<li>
        <a href="javascript:void(0)" class="dropdown-item sendMailBtn" data-bs-toggle="modal" data-bs-target="#ManageOrderSendMailModal" data-email="' . $row['email'] . '" data-id="' . $row['order_item_id'] . '" data-url="admin/orders/">
            ...
            if (!isset($delivery_boy_id)) {
                ...
                $operate .= '<li>
                    <a href="' . base_url((($this->ion_auth->is_seller()) ? "seller" : "admin") . '/invoice/consignment_invoice?edit_id=' . $row['id']) . '" 
                        onclick="consignment_invoice(' . $row['id'] . ')" 
                        class="dropdown-item" 
                        data-id="' . $row['id'] . '">
                        <i class="ti ti-file me-2"></i>Invoice
                    </a>
