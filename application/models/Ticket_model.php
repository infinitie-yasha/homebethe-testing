...
class Ticket_model extends CI_Model
{
    ...
    function get_user_ticket_list($user_id, $search)
    {
        ...
        foreach ($cat_search_res as $row) {
            ...
            $user_id = $row['user_id'];
            $user_group = $this->db->where(['user_id' => $user_id])->get('users_groups')->row_array();
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end table-dropdown-menu">
                    <li>
                        <a class="dropdown-item edit-seller-ticket" href="javascript:void(0)" 
                    ...
                    <li>
                        <a class="dropdown-item text-danger" href="javascript:void(0)"
                       x-data="ajaxDelete({
                           url: base_url + \'seller/support-tickets/delete-ticket\',
                           id: \'' . $row['id'] . '\',
    ...
    function get_ticket_type_list($ticket_type_filter = NULL)
    {
        ...
        foreach ($cat_search_res as $row) {
            ...
            $tempRow['id'] = $row['id'];
            $tempRow['title'] = $row['title'];
            $tempRow['user_type'] = ucfirst($row['for']);
