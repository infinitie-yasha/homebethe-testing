    ...
    <div class="page-header d-print-none" aria-label="Page header">
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          <div class="col">
            <h2 class="page-title">Delivery Boy Policies</h2>
          </div>
            ...
            <div class="d-flex">
              <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                  <a href="#">Delivery Boy Policies</a>
                </li>
              </ol>
            </div>
          </div>
      ...
      <div class="container-xl">
        <div class="card">
          <form x-data="ajaxForm({
                                            url: base_url + 'admin/delivery_boy_privacy_policy/update-privacy-policy-settings',
                                            modalId: '',
                                            loaderText: 'Saving...'
            ...
            <div class="card-body">
              ...
              <div class="d-flex gap-3 align-items-center mb-0">
                ...
                <a href="<?= base_url('admin/delivery-boy-privacy-policy/privacy-policy-page') ?>" target='_blank'
              ...
              <div class="d-flex gap-3 align-items-center mb-0">
                ...
                <a href="<?= base_url('admin/delivery-boy-privacy-policy/terms-and-conditions-page') ?>" target='_blank'
