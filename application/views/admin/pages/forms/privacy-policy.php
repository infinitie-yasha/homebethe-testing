    ...
    <div class="page-header d-print-none" aria-label="Page header">
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          <div class="col">
            <h2 class="page-title">Customer Policies</h2>
          </div>
          ...
          <form x-data="ajaxForm({
            ...
            <div class="card-body">
              ...
              <div class="d-flex gap-3 align-items-center mb-0">
                ...
                <a href="<?= base_url('admin/privacy-policy/privacy-policy-page') ?>" target='_blank'
              ...
              <div class="d-flex gap-3 align-items-center mb-0">
                ...
                <a href="<?= base_url('admin/privacy-policy/terms-and-conditions-page') ?>" target='_blank'
              ...
              <div class="form-group text-end">
                ...
                <button type="submit" class="btn btn-primary btn-2" id="submit_btn">Update Privacy Policy
                  And Terms & Conditions <i class="cursor-pointer ms-2 ti ti-arrow-right"></i></button>
