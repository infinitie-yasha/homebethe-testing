<div class="page-wrapper">
    ...
    <div class="container-xl">
        <div class="row g-3 align-items-center flex-column flex-md-row text-center text-md-start">
            <!-- Page Title -->
            <div class="col">
                <h2 class="page-title mb-2 mb-md-0">Manage Products Ratings</h2>
            </div>

            <!-- Breadcrumb -->
            <div class="col-auto ms-md-auto d-print-none">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-arrows justify-content-center justify-content-md-end mb-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table class='table-striped' id="products_ratings_table" data-toggle="table"
                                data-url="<?= base_url('admin/product_ratings/get_ratings_list') ?>"
