                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <table class='table-striped' id="ticket_table" data-toggle="table"
                                    data-url="<?= base_url('admin/tickets/view_ticket_list') ?>"
                                    data-click-to-select="true" data-side-pagination="server" data-pagination="true"
                                    data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true"
                                    data-show-columns="true" data-show-refresh="true" data-trim-on-search="false"
                                    data-sort-name="t.id" data-sort-order="desc" data-mobile-responsive="true"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="ticket_type" data-sortable="false" data-align='center'>
                                                Ticket
                                                Type</th>
                                            ...
                                            <th data-field="subject" data-sortable="false" data-align='center'>subject
                                            </th>
                                            ...
                                            <th data-field="description" data-sortable="false" data-align='center'>
                                                description</th>
                                            <th data-field="status" data-sortable="false" data-align='center'>Status
                                            </th>
                                            ...
                                            <th data-field="date_created" data-sortable="false" data-align='center'>Date
                                                Created</th>
                                            <th data-field="operate" data-sortable="false" data-align='center'>Actions
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
