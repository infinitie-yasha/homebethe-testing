...
<head>
  ...
  <!-- intlTelInput -->
  <link rel="stylesheet" href="<?= base_url('assets/admin_old/css/intlTelInput.css') ?>" />
  <link rel="stylesheet" href="<?= base_url('assets/admin_old/css/lightbox.css') ?>">
  ...
  <!-- chat -->
  <link rel="stylesheet" href="<?= base_url('assets/admin_old/css/components.css') ?>" />
