        ...
        <div class="row align-items-center">
            ...
            <div class="swiper-container category-swiper ">
                <div class="swiper-wrapper gap-3">
                    <div class="swiper-slide swiper-slide-category">
                        <a href="<?= base_url('home/categories/') ?>" class="text-decoration-none">
                            <img src="<?= base_url('media/image?path=assets/front_end/modern/img/new/dashboard.png&width=110&quality=80') ?>"
                                class=""
                                alt="<?= !empty($this->lang->line('see_all')) ? str_replace('\\', '', $this->lang->line('see_all')) : 'See All'; ?>" />
                            <h6 class="fs-14 mb-0">
                    ...
                    foreach ($categories as $key => $row) { ?>
                        <div class="swiper-slide swiper-slide-category">
                            <a href="<?= base_url('products/category/' . html_escape($row['slug'])) . '/1' ?> "
                                class="brand_image_div mx-2 text-decoration-none">
                                <img class="lazy"
                                    src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                    data-src="<?= base_url('media/image?path=' . rawurlencode($row['relative_path']) . '&width=130&quality=80') ?>"
                ...
                <div class="swiper-controls">
                    <div
                        class="swiper-pagination category-swiper-pagination swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
...
<section class="slider container">
    <div class="pb-md-1">
        <div class="swiper-container swiper-slide-container overflow-hidden" data-margin="30" data-nav="true"
            pagination="true" pagination-dynamic-bullets="true">
                        ...
                        <div class="swiper-slide">
                            <div class="slide-img">
                                <a href="<?= $row['link'] ?>" target="<?= ($row['type'] == "slider_url") ? "_blank" : "" ?>">
                                    <picture>
                                        <source
                                            srcset="<?= base_url('media/image?path=' . $row['image'] . '&width=1000&quality=80') ?>"
                                            media="(max-width: 500px)">
                                        <source
                                            srcset="<?= base_url('media/image?path=' . $row['image'] . '&width=1100&quality=80') ?>"
                                            media="(max-width: 800px)">
                                        <source
                                            srcset="<?= base_url('media/image?path=' . $row['image'] . '&width=1600&quality=80') ?>">

                                        <img class="lazy image-fit rounded-3"
                                            src="<?= base_url('media/image?path=' . $row['image'] . '&width=1300&quality=80') ?>"
                                            data-src="<?= base_url('media/image?path=' . rawurlencode($row['image']) . '&width=1300&quality=80') ?>"
                                            alt="Offer Slider" />
                                    </picture>
        ...
        <div class="swiper-controls">
            <div
                class="swiper-pagination slide-swiper-pagination swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                    ...
                    <div class="d-md-flex justify-content-md-between">
                        <div>
                            <h3 class="text-dark mb-0">
                                <?= !empty($this->lang->line('brands')) ? str_replace('\\', '', $this->lang->line('brands')) : 'Brands'; ?>
                            </h3>
                        </div>
                        <div>
                            <a href="<?= base_url('home/brands/') ?>" class="hover text-decoration-none">
                                <span>
                                    <?= !empty($this->lang->line('see_all')) ? str_replace('\\', '', $this->lang->line('see_all')) : 'See All' ?></span>
                ...
                <div class="swiper-container category-swiper ">
                    <div class="swiper-wrapper">
                        ...
                        foreach ($brands as $key => $row) { ?>
                            <div class="swiper-slide swiper-slide-category">
                                <a href="<?= base_url('products?brand=' . html_escape($row['brand_slug'])) . '&page=1' ?>"
                                    class="brand_image_div mx-2 text-decoration-none">
                                    <img class="lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('media/image?path=' . rawurlencode($row['brand_img']) . '&width=110&quality=80') ?>"
                                        alt="<?= html_escape($row['brand_name']) ?>" />
                    ...
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <div class="offer-img">
                            <a href="<?= $offers[$count_key - 1]['link'] ?>">
                                <img class="img-fluid  my-4 rounded offer-image lazy image-fit"
                                    data-src="<?= base_url('media/image?path=' . rawurlencode($offers[$count_key - 1]['image']) . '&width=1518&quality=80') ?>"
                                    alt="Offer image-<?= $i ?>"
                                    src="https://placehold.co/1290x268?text=Loading%20Offers..%20.&font=Montserrat">
                            </a>
                        </div>
                    <?php }
                } ?>
                ...
                <section class="wrapper mt-4">
                    <div class="my-4 featured-section-title">
                        <div class="align-items-center d-flex justify-content-between">
                            ...
                            <div>
                                <a href="<?= base_url('products/section/' . $row['id'] . '/' . $row['slug']) . '/1' ?>"
                                    class="hover text-decoration-none"><?= !empty($this->lang->line('view_more')) ? str_replace('\\', '', $this->lang->line('view_more')) : 'View More' ?>
                                    <i class="uil uil-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="project item col-6 col-xl-3 default-style mb-3">
                                            <figure class="rounded d-flex justify-content-center">
                                                <div>
                                                    <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                                        ...
                                                        <img class="lazy fig_image image-fit"
                                                            src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                            data-src="<?= $final_image_url ?>" alt="<?= $product_row['name'] ?>">
                                                ...
                                                <div class="desktop_quick_view">
                                                    <a class="item-like text-decoration-none add-to-fav-btn 
                                                        ...
                                                        title="<?= !empty($this->lang->line('add_to_favorite')) ? str_replace('\\', '', $this->lang->line('add_to_favorite')) : 'Add to Favorite' ?>"
                                                    ...
                                                    ?>
                                                    <a href="#" class="compare item-compare text-decoration-none"
                                                        data-tip="<?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>"
                                                        data-bs-toggle="white-tooltip" title="compare"
                                                        data-product-id="<?= $product_row['id'] ?>"
                                                ...
                                                ?>
                                                <div class="desktop_quick_view">
                                                    <a href="#" class="add_to_cart item-cart text-decoration-none"
                                                        data-product-id="<?= $product_row['id'] ?>" data-product-stock="<?= $product_stock ?>"
                                                        data-product-variant-id="<?= $variant_id ?>"
                                            ...
                                            <div class="post-header text-center mt-3">
                                                <input id="input" name="rating" class="rating rating-loading d-none" data-size="xs"
                                                    value="<?= $product_row['rating'] ?>" data-show-clear="false" data-show-caption="false"
                                                    readonly>

                                                <h4 class="title post-title m-0 mt-2 title_wrap fs-16"
            ...
            <?php } else if ($row['style'] == 'style_1') {
                if ($count_key != 0) {
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                            <div class="offer-img">
                                <a href="<?= $offers[$count_key - 1]['link'] ?>">
                                    <img class="img-fluid lazy my-4 rounded offer-image image-fit"
                                        data-src="<?= base_url('media/image?path=' . rawurlencode($offers[$count_key - 1]['image']) . '&width=1518&quality=80') ?>"
                                        alt="Offer image-<?= $i ?>"
                                        src="https://placehold.co/1290x268?text=Loading%20Offers..%20.&font=Montserrat">
                                </a>
                    ...
                    <section class="mt-md-5 wrapper my-5">
                        <div>
                            <div class="align-items-center gx-xl-12 row">
                                <div class="col-lg-9">
                                    <div class="swiper-container text-center mySwiper overflow-hidden" data-margin="30"
                                        data-items-xl="3" data-items-md="2" data-items-xs="2">
                                            ...
                                            if (count($row['product_details']) > 0) {
                                                ...
                                                <?php if ($key != 0) { ?>
                                                        <div class="swiper-slide shadow-xl product-bg slide_image">
                                                            ...
                                                            <?php if (isset($product_row['min_max_price']['special_price']) && $product_row['min_max_price']['special_price'] != '' && $product_row['min_max_price']['special_price'] != 0 && $product_row['min_max_price']['special_price'] < $product_row['min_max_price']['min_price']) { ?>
                                                                    <span
                                                                        class="avatar bg-pink d-flex position-absolute text-uppercase text-white sale_tag">
                                                                        <span
                                                                            class=""><?= !empty($this->lang->line('sale')) ? str_replace('\\', '', $this->lang->line('sale')) : 'Sale' ?></span>
                                                                    </span>
                                                            <?php } ?>
                                                                ...
                                                                <div class="card-body my-4">
                                                                    <input id="input" name="rating" class="rating rating-loading d-none"
                                                                        data-size="xs" value="<?= $product_row['rating'] ?>" data-show-clear="false"
                            ...
                            <div class="bg-white d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="card project item">
                                        <figure class="">
                                            <div class="product-image-container d-flex align-items-center justify-content-center">
                                                ...
                                                ?>
                                                        <img class="lazy fig_image image-fit"
                                                            src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                            data-src="<?= $final_image_url ?>" alt="<?= $first_product['name'] ?>">
                                            ...
                                            <div class="desktop_quick_view">
                                                ...
                                                <a href="#" class="quick-view-btn item-view text-decoration-none" data-bs-toggle="white-tooltip"
                                                    title="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>"
                                                    data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>"
                                                    data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>"
                                                    data-product-id="<?= $first_product['id'] ?>"
                                        ...
                                        ?>
                                                <a href="#" class="compare item-compare text-decoration-none" data-bs-toggle="white-tooltip"
                                                    ...
                                                    data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>"
                                                    data-tip="<?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>"
                                                    data-product-id="<?= $first_product['id'] ?>" data-product-variant-id="<?= $variant_id ?>">
                                                    <i class="uil uil-exchange-alt"></i>
                                                </a>
                                            </div>
                                ...
                                <?php } ?>
                                            ...
                                            <div class="my-4 text-center">
                                                <input id="input" name="rating" class="rating rating-loading d-none" data-size="xs"
                                                    value="<?= $first_product['rating'] ?>" data-show-clear="false" data-show-caption="false"
                                                    readonly>
                                                <div class="product-content mt-2">
                                                    <h4 class="title post-title m-0 title_wrap fs-16"
                                                        title="<?= output_escaping(str_replace('\r\n', '&#13;&#10;', $first_product['name'])) ?>">
                                                        <a class="link-dark text-decoration-none"
                                                            href="<?= base_url('products/details/' . $first_product['slug']) ?>"><?= str_replace('\r\n', '&#13;&#10;', strip_tags($first_product['name'])) ?></a>
                                                    </h4>
                                        ...
                                        ?>
                                                    <a href="#" class="add_to_cart  btn btn-xs btn-outline-primary rounded-pill"
                                                        data-product-id="<?= $first_product['id'] ?>"
                                                        data-product-variant-id="<?= $variant_id ?>" ddata-product-stock="<?= $product_stock ?>"
                                                        data-product-title="<?= $first_product['name'] ?>"
                                                        data-product-slug="<?= $first_product['slug'] ?>"
                                                        data-product-image="<?= $first_product['image']; ?>"
                                                        data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>"
                                                        data-step="<?= $data_step; ?>"
                                                        data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($first_product['short_description'])))); ?>"
                                                        data-izimodal-open="<?= $modal ?>">
                                                        <i
                                                            class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add To Cart' ?></a>
                                                    ...
                                                    <div class="col-md-4 mt-5 col-6">
                                                        <div class="card item project">
                                                            <figure class="">
                                                                ...
                                                                <div class="desktop_quick_view">
                                                                    <a class="item-like text-decoration-none add-to-fav-btn <?= ($product_row['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>"
                                                                        href="#" data-bs-toggle="white-tooltip"
                                                                        title="<?= !empty($this->lang->line('add_to_favorite')) ? str_replace('\\', '', $this->lang->line('add_to_favorite')) : 'Add to Favorite' ?>"
                                                                        data-product-id="<?= $product_row['id'] ?>">
                                                                        <i class=""></i>
...
<?php if (isset($web_settings['app_download_section']) && $web_settings['app_download_section'] == 1) { ?>
    <section class="wrapper bg-soft-grape">
        <div class="align-items-md-center d-flex flex-wrap justify-content-center gap-5 pb-15">
            <div>
                <img class="w-100 lazy" src="<?= THEME_ASSETS_URL . 'demo/avtars/4530199.png' ?>"
                    data-src="<?= THEME_ASSETS_URL . 'demo/avtars/4530199.png' ?>"
                    alt="Download - <?= $web_settings['app_download_section_title'] ?>" />
            ...
            <div class="col-md-7">
                ...
                <p class="lead fs-lg mb-7 px-md-10 px-lg-0 pe-xxl-15">
                    <?= $web_settings['app_download_section_short_description'] ?>
                </p>
                <span><a href="<?= $web_settings['app_download_section_appstore_url'] ?>" target="_blank"
                        class="btn btn-dark btn-icon btn-icon-start rounded-pill me-2"><i class="uil uil-apple"></i>
                        App Store</a></span>
                <span><a href="<?= $web_settings['app_download_section_playstore_url'] ?>" target="_blank"
                        class="btn btn-green btn-icon btn-icon-start rounded-pill"><i class="uil uil-google-play"></i>
                        Google Play</a></span>
            </div>
            <!-- /.row -->
        </div>
