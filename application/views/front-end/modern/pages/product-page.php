        ...
        <div class="container py-3 py-md-5">
            <nav class="d-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 bg-transparent">
                    <li class="breadcrumb-item"><a href="<?= base_url('products') ?>"
                            class="text-decoration-none"><?= !empty($this->lang->line('product')) ? str_replace('\\', '', $this->lang->line('product')) : 'Products' ?></a>
                    </li>
                    <?php
                    $cat_names = array();
                    $cat_slugs = array();
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide swiper-img mb-1 product_main_image">
                                        <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                            data-src="<?= base_url('media/image?path=' . rawurlencode($product['product'][0]['relative_path']) . '&width=75&quality=80') ?>"
                                        ...
                                        foreach ($variant_relative_path as $variant_images) {
                                            if (!empty($variant_images)) {
                                                foreach ($variant_images as $image) { ?>
                                                    <div class="swiper-slide  swiper-img mb-1 product_main_image">
                                                        <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                            data-src="<?= base_url('media/image?path=' . rawurlencode($image) . '&width=75&quality=80') ?>"
                                    ...
                                    if (!empty($product['product'][0]['other_images_relative_path']) && isset($product['product'][0]['other_images_relative_path'])) {
                                        foreach ($product['product'][0]['other_images_relative_path'] as $other_image) {
                                            ...
                                            <div class="swiper-slide  swiper-img mb-1 product_main_image">
                                                <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                    data-src="<?= base_url('media/image?path=' . rawurlencode($other_image) . '&width=75&quality=80') ?>"
                                                    class="rounded p-1 lazy" alt="">
                                            </div>
                                        <?php }
                                    } ?>
                                    ...
                                    if (isset($product['product'][0]['video_type']) && !empty($product['product'][0]['video_type'])) {
                                        ...
                                        <div class="swiper-slide  swiper-img mb-1 product_main_image">
                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                data-src="<?= base_url('assets/admin/images/video-file.png') ?>"
                                                class="rounded p-1 lazy" alt="">
                                        </div>
                                    <?php } ?>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <figure class="rounded">
                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                data-src="<?= base_url('media/image?path=' . rawurlencode($product['product'][0]['relative_path']) . '&width=900&quality=80') ?>"
                                                alt="" class="lazy product_other_images">
                                            <a class="item-link text-decoration-none"
                                                href="<?= base_url('media/image?path=' . $product['product'][0]['relative_path'] . '&width=900&quality=80') ?>"
                                            ...
                                            if (!empty($variant_images)) {
                                                foreach ($variant_images as $image) {
                                                    ...
                                                    <div class="swiper-slide 12345">
                                                        <figure class="rounded">
                                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                                data-src="<?= base_url('media/image?path=' . rawurlencode($image) . '&width=900&quality=80') ?>"
                                                                class="lazy product_other_images" alt="">
                                                            <a class="item-link text-decoration-none"
                                                                href="<?= base_url('media/image?path=' . $image . '&width=900&quality=80') ?>"
                                                                data-glightbox="" data-gallery="product-group"><i
                                                                    class="uil uil-focus-add"></i></a>
                                                        </figure>
                                                    </div>
                                    ...
                                    if (!empty($product['product'][0]['other_images_relative_path']) && isset($product['product'][0]['other_images_relative_path'])) {
                                        foreach ($product['product'][0]['other_images_relative_path'] as $other_image) {
                                            ...
                                            <div class="swiper-slide">
                                                <figure class="rounded">
                                                    <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                        data-src="<?= base_url('media/image?path=' . rawurlencode($other_image) . '&width=900&quality=80') ?>"
                                                        class="lazy product_other_images" alt="" id="img_01">
                                                    <a class="item-link text-decoration-none"
                                                        href="<?= base_url('media/image?path=' . $other_image . '&width=900&quality=80') ?>"
                                                        data-glightbox="" data-gallery="product-group"><i
                                                            class="uil uil-focus-add"></i></a>
                                                </figure>
                                            </div>
                                            ...
                                            <figure class="rounded">
                                                <?php if ($product['product'][0]['video_type'] == 'self_hosted') { ?>
                                                    <video controls width="320" height="240"
                                                        src="<?= $product['product'][0]['video'] ?>" controlsList="nodownload"
                    ...
                    <div class="swiper swiper-container preview-image-swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide text-center"><img class="lazy"
                                    ...
                                    data-src="<?= base_url('media/image?path=' . rawurlencode($product['product'][0]['relative_path']) . '&width=800&quality=80') ?>">
                            </div>
                            <?php
                            if (!empty($product['product'][0]['other_images_relative_path']) && isset($product['product'][0]['other_images_relative_path'])) {
                                foreach ($product['product'][0]['other_images_relative_path'] as $other_image) {
                                    ...
                                    <div class="swiper-slide text-center">
                                        <img class="lazy"
                                            src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                            data-src="<?= base_url('media/image?path=' . rawurlencode($other_image) . '&width=800&quality=80') ?>">
                                    </div>
                                <?php }
                            } ?>
                            <?php
                                    ...
                                    if (!empty($variant_images)) {
                                        foreach ($variant_images as $image) {
                                            ...
                                            <div class="swiper-slide text-center">
                                                <img class="lazy"
                                                    src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                    data-src="<?= base_url('media/image?path=' . rawurlencode($image) . '&width=800&quality=80') ?>"
                                                    data-zoom-image="">
                                            </div>
            ...
            <div class="col-md-5">
                <div class="post-header mb-5">
                    <h3 class="post-title"><a href=""
                            class="link-dark text-decoration-none"><?= ucfirst($product['product'][0]['name']) ?></a>
                    </h3>
                    <p class="mb-1">
                        ...
                        <p class="my-1">
                            <span class="rotator-zoom text-blue">
                                <?php if ($statistics['total_ordered'] > 0) { ?>
                                    🛒<?php print_r($statistics['total_ordered']) ?>
                                    <?= !empty($this->lang->line('item(s)_sold_in_last_30_days')) ? str_replace('\\', '', $this->lang->line('item(s))_sold_in_last_30_days')) : 'item(s) sold in last 30 days' ?>
                                <?php } ?>,
                                <?php if ($statistics['total_in_cart'] > 0) { ?>
                                    🚀<?php print_r($statistics['total_in_cart']) ?>
                                    <?= !empty($this->lang->line('people_have_added_this_to_cart')) ? str_replace('\\', '', $this->lang->line('people_have_added_this_to_cart')) : 'people have added this to cart' ?>
                                <?php } ?> ,
                                <?php if ($statistics['total_favorites'] > 0) { ?>
                                    ❤️<?php print_r($statistics['total_favorites']) ?>
                                    <?= !empty($this->lang->line('people_have_added_to_wishlist')) ? str_replace('\\', '', $this->lang->line('people_have_added_to_wishlist')) : 'people have added to wishlist' ?>
                                <?php } ?>
                            </span>
                        </p>
                    <?php } ?>
                    ...
                    if ($indicator == '1') { ?>
                        <span
                            class="badge badge-success"><?= !empty($this->lang->line('veg')) ? str_replace('\\', '', $this->lang->line('veg')) : 'Veg' ?></span>
                    <?php } elseif ($indicator == '2') { ?>
                        <span
                            class="badge badge-danger"><?= !empty($this->lang->line('non_veg')) ? str_replace('\\', '', $this->lang->line('non_veg')) : 'Non Veg' ?></span>
                    <?php } ?>
                    ...
                    <div class="d-flex gap-1 pl-0 product-rating-small" dir="ltr">
                        <input id="input" name="rating" class="rating rating-loading d-none mt-n5" data-size="xs"
                            value="<?= $product['product'][0]['rating'] ?>" data-show-clear="false"
                            data-show-caption="false" readonly>
                        <span class="my-auto ml-0 text-muted"> (
                            <?= ($product['product'][0]['no_of_ratings'] > 0 ? $product['product'][0]['no_of_ratings'] : "No") ?>
                            <?= !empty($this->lang->line('reviews')) ? str_replace('\\', '', $this->lang->line('reviews')) : 'reviews' ?>
                            ) </span>
                    </div>
                                                        ...
                                                        <ul class="p-0 mb-0">
                                                            <li class="list-unstyled">
                                                                <label class="btn text-center fullCircle rounded-circle p-3" <?= $color_code ?>>
                                                                    <input type="radio" name="<?= $attribute['attr_name'] ?>"
                                                                        value="<?= $attribute_ids[$key] ?>" autocomplete="off"
                                                                        class="attributes filter-input">
                                                                </label>
                                                            </li>
                                                            ...
                                                            <ul class="p-0 mb-0">
                                                                <li class="list-unstyled">
                                                                    <label class="btn text-center ">
                                                                        <img class="swatche-image lazy category-image-container"
                                                                            src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                                            data-src="<?= $swatche_values[$key] ?>">
                                                                        <input type="radio" name="<?= $attribute['attr_name'] ?>"
                                                                            value="<?= $attribute_ids[$key] ?>" autocomplete="off" class="attributes">
                                                                        <br>
                                                                    </label>
                                                                </li>
                                                            </ul>
                                        ...
                                        foreach ($attribute_values as $key => $row) {
                                            ...
                                            <?php } else { ?>
                                                <?= '<style> .product-page-details .btn-group>.active { background-color: var(--primary-color);color: white!important;}</style>'; ?>
                                                    <ul class="p-0 mb-0">
                                                        <li class="list-unstyled">
                                                            <label class="btn btn-aqua btn-default btn-xs mb-0 rounded-2 text-center">
                                                            <?= $row ?>
                                                                <input type="radio" name="<?= $attribute['attr_name'] ?>"
                                                                    value="<?= $attribute_ids[$key] ?>" autocomplete="off" class="attributes">
                                                                <br>
                    ...
                    if ($product['product'][0]['type'] != 'digital_product') { ?>
                        ...
                        if ((isset($shiprocket_settings['pincode_wise_deliverability']) && $shiprocket_settings['pincode_wise_deliverability'] == 1) || (isset($shiprocket_settings['local_shipping_method']) && isset($shiprocket_settings['shiprocket_shipping_method']) && $shiprocket_settings['local_shipping_method'] == 1 && $shiprocket_settings['shiprocket_shipping_method'] == 1)) {
                            ...
                            <form class="mt-2" id="validate-zipcode-form" method="POST">
                                <div class="input-group">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm ml-0" id="validate_zipcode"
                                        <?= ($this->ion_auth->logged_in()) ? '' : 'disabled' ?>><?= !empty($this->lang->line('check_availability')) ? str_replace('\\', '', $this->lang->line('check_availability')) : 'Check Availability' ?></button>
                                </div>
                                <div class="mt-2" id="error_box">
                                    <?php if (!empty($product['product'][0]['zipcode'])) { ?>
                                        <p
                                            class="m-0 text-<?= ($product['product'][0]['is_deliverable']) ? "success" : "danger" ?>">
                                            <?= !empty($this->lang->line('product_is')) ? str_replace('\\', '', $this->lang->line('product_is')) : 'Product is' ?>
                                            <?= ($product['product'][0]['is_deliverable']) ? "" : "not" ?>
                                            <?= !empty($this->lang->line('delivarable_on')) ? str_replace('\\', '', $this->lang->line('delivarable_on')) : 'Delivarable on' ?>
                                            &quot; <?= $product['product'][0]['zipcode']; ?> &quot;
                                        </p>
                                    <?php } ?>
                                </div>
                            </form>
                        ...
                        if (isset($shiprocket_settings['city_wise_deliverability']) && $shiprocket_settings['city_wise_deliverability'] == 1 && $shiprocket_settings['shiprocket_shipping_method'] != 1) { ?>
                            <form class="mt-2" id="validate-city-form" method="POST">
                                <div class="input-group">
                                    <input type="hidden" name="product_id" value="<?= $product['product'][0]['id'] ?>">
                                    <input type="text" class="form-control rounded" id="zipcode" placeholder="City" name="city"
                                        autocomplete="off" required value="<?= $product['product'][0]['zipcode']; ?>">
                                    <button type="submit" class="btn btn-primary btn-sm ml-0" id="validate_city"
                                        <?= ($this->ion_auth->logged_in()) ? '' : 'disabled' ?>><?= !empty($this->lang->line('check_availability')) ? str_replace('\\', '', $this->lang->line('check_availability')) : 'Check Availability' ?></button>
                                </div>
                                <div class="mt-2" id="error_box">
                                    <?php if (!empty($product['product'][0]['zipcode'])) { ?>
                    ...
                    <div class="col-lg-10 d-flex flex-row pt-2 gap-1 product-page-div p-0">
                        ...
                        <?php if ($product['product'][0]['variants'][0]['cart_count'] != 0) { ?>
                            <a class="btn btn-yellow btn-icon btn-xs btn-icon-start rounded-pill"
                                href="<?= base_url('cart') ?>"><i class='uil uil-arrow-right'></i>
                                <?= !empty($this->lang->line('go_to_cart')) ? str_replace('\\', '', $this->lang->line('go_to_cart')) : 'Go To Cart' ?></a>
                        <?php } else { ?>
                            <button type="button" name="add_cart" class="add_to_cart btn btn-xs btn-yellow rounded-pill "
                                id="add_cart"
                                title="<?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add to Cart' ?>"
                                ...
                                <?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add to Cart' ?>
                            </button>
                        <?php } ?>
                        <button type="button" name="buy_now" class="buy_now btn btn-xs btn-danger rounded-pill"
                            id="buy_now"
                            title="<?= !empty($this->lang->line('buy_now')) ? str_replace('\\', '', $this->lang->line('buy_now')) : 'Buy Now' ?>"
                            data-product-id="<?= $product['product'][0]['id'] ?>"
                            data-product-title="<?= $product['product'][0]['name'] ?>"
                            data-product-slug="<?= $product['product'][0]['slug'] ?>"
                            data-product-reference_id="<?= (isset($reference_id) && !empty($reference_id)) ? $reference_id : '' ?>"
                            ...
                            data-product-variant-id="<?= $variant_id ?>" <?= ($this->ion_auth->logged_in()) ? '' : 'disabled' ?>>
                            <i
                                class="mr-2 uil uil-bolt-alt"></i><?= !empty($this->lang->line('buy_now')) ? str_replace('\\', '', $this->lang->line('buy_now')) : 'Buy Now' ?>
                        </button>
                        <button type="button" name="compare"
                            class="btn btn-outline-blue btn-icon btn-sm rounded-pill w-15 p-0 compare" id="compare"
                            title="<?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>"
                            data-product-id="<?= $product['product'][0]['id'] ?>"
                        ...
                        <button
                            class="item-like text-decoration-none btn-outline-red btn-sm rounded-pill w-15 p-0 fs-19 fav_button_dif add-to-fav-btn <?= ($product['product'][0]['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>"
                            href="#"
                            title="<?= !empty($this->lang->line('add_to_wishlist')) ? str_replace('\\', '', $this->lang->line('add_to_wishlist')) : 'Add To wishlist' ?>"
                            data-product-id="<?= $product['product'][0]['id'] ?>">
                            <i class=""></i>
                        </button>
                        ...
                        if (isset($settings['whatsapp_status']) && $settings['whatsapp_status'] == 1 && isset($settings['whatsapp_number'])) { ?>
                            <a href="https://api.whatsapp.com/send?phone= <?= ($settings['whatsapp_number'] != '' && isset($settings['whatsapp_number'])) ? $settings['whatsapp_number'] : ((!defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['whatsapp_number']) - 3) . substr($settings['whatsapp_number'], -3) : $settings['whatsapp_number']) ?> &amp;text=Hello, I Seen This <?= $product['product'][0]['name'] ?> In Your Website And I Want to Buy This <?= base_url('products/details/' . $product['product'][0]['slug']) ?>"
                                target="_blank" title="Order From Whatsapp"
                                class=" btn btn-success  btn-outline-blue btn-icon btn-sm rounded-pill w-15 p-0">
                    ...
                    <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                        ...
                        <?php if ($this->ion_auth->logged_in()) { ?>
                            <div class="">
                                <?= !empty($this->lang->line('seller')) ? str_replace('\\', '', $this->lang->line('chat_with')) : 'Chat With' ?>
                                <?php if (isset($product['product'][0]['seller_name']) && !empty($product['product'][0]['seller_name'])) { ?>
                                    <a id="chat-with-button" class="text-success"
                                        data-id="<?= $product['product'][0]['seller_id'] ?>" href="#">
                        ...
                        <?php if (isset($product['product'][0]['cod_allowed']) && !empty($product['product'][0]['cod_allowed']) && $product['product'][0]['cod_allowed'] == 1 && $payment_methods['cod_method'] == 1) { ?>
                            <div>
                                <div class="product-permission">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/cod_logo.png') ?>">
                                </div>
                        ...
                        <div>
                            <?php if (isset($product['product'][0]['is_cancelable']) && !empty($product['product'][0]['is_cancelable']) && $product['product'][0]['is_cancelable'] == 1) { ?>
                                <div class="product-permission" class="ml-4">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/cancelable.png') ?>">
                                </div>
                                <div class="fs-13 product-permission-text">
                                    <?= !empty($this->lang->line('cancelable_till')) ? str_replace('\\', '', $this->lang->line('cancelable_till')) : 'Cancelable till' ?>
                                    <?= ' ' . $product['product'][0]['cancelable_till'] ?>
                                </div>
                            <?php } else { ?>
                                <div class="product-permission" class="ml-4">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/notcancelable.png') ?>">
                                </div>
                                <div class="fs-13 product-permission-text">
                        ...
                        <div>
                            <?php if (isset($product['product'][0]['is_returnable']) && !empty($product['product'][0]['is_returnable']) && $product['product'][0]['is_returnable'] == 1) { ?>
                                <div class="product-permission" class="ml-4">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/returnable.png') ?>">
                                </div>
                                <div class="fs-13 product-permission-text">
                                    <?= $settings['max_product_return_days'] ?>
                                    <?= !empty($this->lang->line('days_returnable')) ? str_replace('\\', '', $this->lang->line('days_returnable')) : 'Days Returnable' ?>
                                </div>
                            <?php } else { ?>
                                <div class="product-permission" class="ml-4">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/notreturnable.png') ?>">
                                </div>
                                <div class="fs-13 product-permission-text">
                        ...
                        <?php if (isset($product['product'][0]['guarantee_period']) && !empty($product['product'][0]['guarantee_period'])) { ?>
                            <div>
                                <div class="product-permission" class="ml-4">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/guarantee.png') ?>">
                                </div>
                                <div class="fs-13 product-permission-text">
                                    <?= $product['product'][0]['guarantee_period'] ?>
                                    <?= !empty($this->lang->line('guarantee')) ? str_replace('\\', '', $this->lang->line('guarantee')) : 'Guarantee' ?>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if (isset($product['product'][0]['warranty_period']) && !empty($product['product'][0]['warranty_period'])) { ?>
                            <div>
                                <div class="product-permission" class="ml-4">
                                    <img class="h-5 lazy"
                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                        data-src="<?= base_url('assets/front_end/classic/images/warranty.png') ?>">
                                </div>
                                <div class="fs-13 product-permission-text">
                                    <?= $product['product'][0]['warranty_period'] ?>
                                    <?= !empty($this->lang->line('warranty')) ? str_replace('\\', '', $this->lang->line('warranty')) : 'Warranty' ?>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <?php if (isset($product['product'][0]['cod_allowed']) && !empty($product['product'][0]['cod_allowed']) && $product['product'][0]['cod_allowed'] == 1 && $payment_methods['cod_method'] == 1) { ?>
                        <span class="fs-14 fw-bolder text-info">Cash on Delivery is eligible for orders above
                            <?= $settings['currency'] . $payment_methods['min_cod_amount'] ?> and below
                            <?= $settings['currency'] . $payment_methods['max_cod_amount'] ?></span>
                    <?php } ?>
                    ...
                    <div class="mt-3">
                        <table class="product-detail-tab">
                            ...
                            if (isset($product['product'][0]['made_in']) && !empty($product['product'][0]['made_in']) && $product['product'][0]['made_in'] != '') { ?>
                                <tr>
                                    <td><?= !empty($this->lang->line('made_in')) ? str_replace('\\', '', $this->lang->line('made_in')) : 'Made In : ' ?>
                                    </td>
                            ...
                            if (isset($product['product'][0]['brand']) && !empty($product['product'][0]['brand']) && $product['product'][0]['brand'] != '') {
                                ...
                                if (isset($brand_img) && !empty($brand_img)) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><?= !empty($this->lang->line('brand')) ? str_replace('\\', '', $this->lang->line('brand')) : 'Brand : ' ?>
                                        </td>
                                        <td>
    ...
    <div class="container mt-n6">
        <div class="row mt-4">
            ...
            <div class="nav" id="product-tab" role="tablist">
                <nav class="w-100">
                    <ul class="nav nav-tabs nav-tabs-basic">
                        <li class="nav-item">
                            <?php if (isset($product['product'][0]['description']) && !empty($product['product'][0]['description'])) { ?>
                                <a class="nav-item nav-link product-nav-tab active fs-15" id="product-desc-tab"
                                    ...
                                    aria-selected="true"><?= !empty($this->lang->line('description')) ? str_replace('\\', '', $this->lang->line('description')) : 'Description' ?></a>
                            <?php } ?>
                        </li>
                        <li class="nav-item">
                            <?php if (isset($product['product'][0]['description']) && !empty($product['product'][0]['description'])) { ?>
                                ...
                                <a class="nav-item nav-link product-nav-tab fs-15" id="product-review-tab" data-toggle="tab"
                                    ...
                                    aria-selected="false"><?= !empty($this->lang->line('reviews')) ? str_replace('\\', '', $this->lang->line('reviews')) : 'Reviews' ?></a>
                            <?php } else { ?>

                                <a class="nav-item nav-link product-nav-tab  active fs-15" id="product-review-tab"
                                    data-toggle="tab" href="#product-review" role="tab" aria-controls="product-review"
                                    aria-selected="false"><?= !empty($this->lang->line('reviews')) ? str_replace('\\', '', $this->lang->line('reviews')) : 'Reviews' ?></a>
                        ...
                        <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                            <li class="nav-item">
                                <a class="nav-item nav-link product-nav-tab fs-15 <?= !isset($product['product'][0]['description']) && empty($product['product'][0]['description']) ? 'active' : '' ?>"
                                    id="product-seller-tab" data-toggle="tab" href="#product-seller" role="tab"
                                    aria-controls="product-seller"
                                    aria-selected="false"><?= !empty($this->lang->line('sold_by')) ? str_replace('\\', '', $this->lang->line('sold_by')) : 'Sold by' ?></a>
                            </li>
                        <?php } ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-item nav-link product-nav-tab fs-15" id="product-faq-tab" data-toggle="tab"
                                ...
                                aria-selected="true"><?= !empty($this->lang->line('faq')) ? str_replace('\\', '', $this->lang->line('faq')) : 'FAQ' ?></a>
                        </li>
                    </ul>
                </nav>
            </div>
            <div class="tab-content p-3 w-100" id="nav-tabContent">
                                    ...
                                    <?php if ((!isset($faq['data']) && empty($faq['data'])) || $faq['data'] == []) { ?>
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="d-flex flex-column">
                                                <img class=""
                                                    src="<?= base_url('assets/front_end/modern/img/no-faq.jpg') ?>"
                                                    alt="No Faq" width="160px" />
                                                <h4><?= !empty($this->lang->line('no_faqs_found')) ? str_replace('\\', '', $this->lang->line('no_faqs_found')) : 'No FAQs Found' ?>
                                                </h4>
                                            </div>
                                            <div>
                                                <?php if ($this->ion_auth->logged_in()) { ?>
                                                    <div class=" add-faqs-form float-right">
                                                        <button class="btn btn-outline-primary btn-xs mt-2 rounded-pill"
                                                            type="submit" data-toggle="modal" data-target="#add-faqs-form"><i
                                                                class="uil uil-plus" aria-hidden="true"></i> &nbsp;Add your
                                                            question here</button>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card plain accordion-item">
                                                    <div class="card-header" id="<?= "h-" . $row['id'] ?>">
                                                        <button class="accordion-button collapsed" data-bs-toggle="collapse"
                                                            data-bs-target="#<?= "c-" . $row['id'] ?>" aria-expanded="true"
                                                    ...
                                                    <div id="<?= "c-" . $row['id'] ?>" class="accordion-collapse collapse"
                ...
                <!-- product review tab -->
                <div class="tab-pane fade <?= (isset($product['product'][0]['description']) && !empty($product['product'][0]['description'])) ? "" : "active show" ?>"
                                            ...
                                            if ($count == 8 && !empty($review_images['product_rating'][$i]['images'][$j])) {
                                                ...
                                                <div class="mt-4">
                                                    <a href="<?= $review_images['product_rating'][$i]['images'][$j]; ?>"
                                                        class="text-decoration-none" data-izimodal-open="#user-review-images"
                                                        id="review-image-title" data-reached-end="false"
                                                        data-izimodal-open="#user-review-images" data-review-limit="1" data-review-offset="0"
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="review-img">
                                                            ...
                                                            <a href="<?= $review_images['product_rating'][$i]['images'][$j]; ?>"
                                                                ...
                                                                <img class="lazy"
                                                                    src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                                    data-src="<?= $review_images['product_rating'][$i]['images'][$j]; ?>"
                                                                    alt="Review Images">
                                                            </a>
                    ...
                    <div class="row mt-10">
                        <aside class="col-lg-4 sidebar">
                                ...
                                <div id="rating-box" class="">
                                    <div class="add-review p-3 bg-soft-primary">
                                        <h3 class="text-center mb-4">
                                            <?= !empty($this->lang->line('edit_your_review')) ? str_replace('\\', '', $this->lang->line('edit_your_review')) : 'Edit Your Review' ?>
                                        </h3>
                                        <form action="<?= $form_link ?>" id="product-rating-form" method="POST">
                                            ...
                                            <label for="rating"
                                                class="fs-17"><?= !empty($this->lang->line('your_rating')) ? str_replace('\\', '', $this->lang->line('your_rating')) : 'Your rating' ?></label>
                                            <div class="pl-0 product-rating-small rating-form mb-2 mt-n2" dir="ltr">
                                                <input id="input" name="rating" class="rating rating-loading d-none mt-n5"
                                                    data-size="xs"
                                            ...
                                            <div class="form-group fs-17">
                                                <label
                                                    for="exampleFormControlTextarea1"><?= !empty($this->lang->line('your_review')) ? str_replace('\\', '', $this->lang->line('your_review')) : 'Your Review' ?></label>
                                                <textarea class="form-control" name="comment"
                                                    rows="3"><?= isset($my_rating['product_rating'][0]['comment']) ? $my_rating['product_rating'][0]['comment'] : '' ?></textarea>
                                            </div>
                                            <div class="form-group fs-17">
                                                <label
                                                    for="exampleFormControlTextarea1"><?= !empty($this->lang->line('images')) ? str_replace('\\', '', $this->lang->line('images')) : 'Images' ?></label>
                                                <input type="file" name="images[]" accept="image/x-png,image/gif,image/jpeg"
                                                    multiple />
                                            </div>
                                            <button class="btn btn-primary rounded-pill w-100"
                                                id="rating-submit-btn"><?= !empty($this->lang->line('submit')) ? str_replace('\\', '', $this->lang->line('submit')) : 'Submit' ?></button>
                                        </form>
                                    </div>
                                </div>
                            <?php } ?>
                            <?php if ($product['product'][0]['is_purchased'] == 1) {
                                ...
                                ?>
                                <div class=" p-3 bg-soft-primary <?= (!empty($my_rating)) ? 'd-none' : '' ?>"
                                    id="rating-box">
                                    <div class="add-review">
                                        <h3 class="review-title">
                                            <?= !empty($this->lang->line('add_your_review')) ? str_replace('\\', '', $this->lang->line('add_your_review')) : 'Add Your Review' ?>
                                        </h3>
                                        <form action="<?= $form_link ?>" id="product-rating-form" method="POST">
                                            <?php if (!empty($my_rating)) { ?>
                                                <input type="hidden" name="rating_id"
                                            ...
                                            <label for="rating"
                                                class="fs-17"><?= !empty($this->lang->line('your_rating')) ? str_replace('\\', '', $this->lang->line('your_rating')) : 'Your rating' ?></label>
                                            <div class="col-md-12 pl-0 product-rating-small rating-form fs-17 mt-n2 mb-2"
                                                dir="ltr">
                                                <input id="input" name="rating" class="rating rating-loading d-none mt-n5"
                                                    data-size="xs"
                                                    value="<?= isset($my_rating['product_rating'][0]['rating']) ? $my_rating['product_rating'][0]['rating'] : '0' ?>"
                        ...
                        <div class="col-md-12 order-md-2 <?= (isset($user->id) == 1) ? "col-lg-7" : "col-lg-12" ?>">
                            ...
                            <div id="comments">
                                <h3 class="review-title mb-2"> <span
                                    ...
                                    <?= !empty($this->lang->line('reviews_for_this_product')) ? str_replace('\\', '', $this->lang->line('reviews_for_this_product')) : 'Reviews For this Product' ?>
                                </h3>
                                            ...
                                            <li class="comment mb-5">
                                                <div class="comment-header d-md-flex align-items-center">
                                                    <figure class="user-avatar">
                                                        <img class="rounded-circle h-9 w-9 lazy" alt=""
                                                            src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                            data-src="<?= THEME_ASSETS_URL . 'img/user.png' ?>" />
                                                    </figure>
                                                    <div>
                                                        <h6 class="comment-author"><a href="#"
                                                                class="link-dark"><?= $row['user_name'] ?></a></h6>
                                                        <ul class="post-meta">
                                                            <li>
                                                ...
                                                <div class="d-flex flex-row align-items-center mt-n3">
                                                    <input id="input" name="rating" class="rating rating-loading d-none"
                                                        data-size="xs" value="<?= $row['rating'] ?>" data-show-clear="false"
                                                        data-show-caption="false" readonly>
                                                </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="review-img">
                                                                ...
                                                                <a href="<?= $image; ?>" data-lightbox="review-images">
                                                                    <img class="lazy"
                                                                        src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                                                        data-src="<?= $image; ?>" alt="Review Image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                    ...
                    <div class="align-items-center container d-flex flex-wrap gap-3">
                        <div class="seller-image-container">
                            <img class="lazy pic-1"
                                src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                data-src="<?= $product['product'][0]['seller_profile'] ?>">
                        </div>
                        <div>
                            <div class="card-body-right seller_tab">
                                ...
                                <a target="_BLANK" href="<?= base_url('products?seller=' . $seller_slug[0]['slug']) ?>"
...
<section class="wrapper bg-gray">
    <div class="container pb-10 overflow-hidden">
        <h3 class="h2 my-5 text-center">
            <?= !empty($this->lang->line('related_products')) ? str_replace('\\', '', $this->lang->line('related_products')) : 'Related Products' ?>
        </h3>
                        ...
                        <div class="swiper-slide shadow-xl product-bg swiper-slide-style4">
                            <figure class="rounded ">
                                <div>
                                    <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                        <img class="lazy fig_image image-fit"
                                            src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>"
                                            data-src="<?= base_url('media/image?path=' . rawurlencode($product_row['relative_path']) . '&width=640&quality=80') ?>"
                                ...
                                <a href="#" class="quick-view-btn item-view text-decoration-none"
                                    ...
                                    title="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>"
                                    data-tip="<?= !empty($this->lang->line('quick_view')) ? str_replace('\\', '', $this->lang->line('quick_view')) : 'Quick View' ?>"
                                    data-product-id="<?= $product_row['id'] ?>"
                                ...
                                <a href="#" class="compare item-compare text-decoration-none" data-bs-toggle="white-tooltip"
                                    title="<?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>"
                                    data-tip="<?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>"
                                    data-product-id="<?= $product_row['id'] ?>"
                                    data-product-variant-id="<?= $variant_id ?>">
                                ...
                                <?php if (isset($product_row['min_max_price']['special_price']) && $product_row['min_max_price']['special_price'] != '' && $product_row['min_max_price']['special_price'] != 0 && $product_row['min_max_price']['special_price'] < $product_row['min_max_price']['min_price']) { ?>
                                    <span class="avatar bg-pink d-flex position-absolute text-uppercase text-white sale_tag">
                                        <span
                                            class=""><?= !empty($this->lang->line('sale')) ? str_replace('\\', '', $this->lang->line('sale')) : 'Sale' ?></span>
                                    </span>
                                <?php } ?>

                                <div class="card-body my-4 style_4">
                                    <input id="input" name="rating" class="rating rating-loading d-none" data-size="xs"
                                        value="<?= $product_row['rating'] ?>" data-show-clear="false"
                                        data-show-caption="false" readonly>
                                    <div class="product-content mt-2">
                                        <h4 class="title post-title m-0 title_wrap fs-16"
                                            title="<?= output_escaping(str_replace('\r\n', '&#13;&#10;', $product_row['name'])) ?>">
                                            <a class="link-dark text-decoration-none"
                                                href="<?= base_url('products/details/' . $product_row['slug']) ?>"><?= str_replace('\r\n', '&#13;&#10;', strip_tags($product_row['name'])) ?></a>
                                        </h4>
                                        ...
                                        <a href="#" class="add_to_cart btn btn-xs btn-outline-primary rounded-pill"
                                            ...
                                            <i
                                                class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add To Cart' ?></a>
                                    </div>
                                </div>
                            </figure>
                            <!-- /.social -->
