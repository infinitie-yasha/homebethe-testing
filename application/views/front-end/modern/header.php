...
<input type="hidden" id="allow_items_in_cart" name="allow_items_in_cart"
    value='<?= isset($allow_items_in_cart['max_items_cart']) ? $allow_items_in_cart['max_items_cart'] : '10'; ?>'>
<input type="hidden" id="low_stock_limit" name="low_stock_limit"
    value='<?= isset($allow_items_in_cart['low_stock_limit']) ? $allow_items_in_cart['low_stock_limit'] : '10'; ?>'>
...
<input type="hidden" id="decimal_point" name="decimal_point"
    value='<?= isset($allow_items_in_cart['decimal_point']) ? $allow_items_in_cart['decimal_point'] : '2'; ?>'>
        ...
        <header class="wrapper bg-light">
                        ...
                        <ul class="align-items-center flex-row ms-auto navbar-nav">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg">
                                    <?php foreach ($language as $row) { ?>
                                        <a href="<?= base_url('home/lang/' . strtolower($row['language'])) ?>"
                                            class="dropdown-item"><?= strtoupper($row['code']) . ' - ' . ucfirst($row['language']);
                            ...
                            <?php if ($this->ion_auth->logged_in()) {
                                ...
                                <li class="nav-item dropdown active">
                                    <a class="text-decoration-none" data-toggle="dropdown" href="#"><i
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg">
                                        <a href="<?= base_url('my-account/wallet') ?>"
                                            class="dropdown-item text-decoration-none" aria-label="wallet"><i
                                                class="uil uil-wallet mr-2 text-primary link-color"></i>
                                        ...
                                        <a href="<?= base_url('my-account/profile') ?>"
                                            class="dropdown-item text-decoration-none" aria-label="my profile"><i
                                                class="uil uil-user text-primary link-color mr-2"></i>
                                            <?= !empty($this->lang->line('profile')) ? str_replace('\\', '', $this->lang->line('profile')) : 'Profile' ?>
                                        </a>
                                        <a href="<?= base_url('my-account/orders') ?>"
                                            class="dropdown-item text-decoration-none" aria-label="orders"><i
                                                class="link-color mr-2 text-primary uil uil-history"></i>
                                            <?= !empty($this->lang->line('orders')) ? str_replace('\\', '', $this->lang->line('orders')) : 'Orders' ?>
                                        </a>
                                        <a href="<?= base_url('my-account/delete_account') ?>"
                                            class="dropdown-item text-decoration-none" aria-label="orders"><i
                                                class="link-color mr-2 text-primary uil uil-user-minus"></i>
                                            <?= !empty($this->lang->line('delete_account')) ? str_replace('\\', '', $this->lang->line('delete_account')) : 'Delete Account' ?>
                                        </a>
                                        <a href="" class="dropdown-item text-decoration-none" id="user_logout"
                                            aria-label="logout"><i
                                                class="link-color mr-2 text-primary uil uil-signout"></i><?= !empty($this->lang->line('logout')) ? str_replace('\\', '', $this->lang->line('logout')) : 'Logout' ?></a>
                                    </div>
                                </li>
                            ...
                            <?php } else { ?>
                                <li class="nav-item active">
                                    <a href="#" aria-label="login" class="mx-1 mb-2 mb-md-0 text-decoration-none hover"
                                        ...
                                        data-bs-target="#modal-signin"><?= !empty($this->lang->line('login')) ? str_replace('\\', '', $this->lang->line('login')) : 'Login' ?>
                                    </a>
                                </li>
                                /
                                <li class="nav-item active">
                                    <a href="#" aria-label="register" class="mx-1 mb-2 mb-md-0 text-decoration-none hover"
                                        data-bs-toggle="modal"
                                        data-bs-target="#modal-signup"><?= !empty($this->lang->line('register')) ? str_replace('\\', '', $this->lang->line('register')) : 'Register' ?>
                                    </a>
                                </li>
                            <?php } ?>
                            <!-- </div> -->
                ...
                <div class="container flex-lg-row flex-nowrap align-items-center">
                    <div class="navbar-brand w-100 logo-img">
                        <a class="ml-2" href="<?= base_url() ?>">
                            <?php if (ALLOW_MODIFICATION == 0) { ?>
                                <img src="<?= base_url("assets/front_end/modern/img/logo/orange.png") ?>"
                                    alt="site-logo image" class="brand-logo-link logo-img logo-fit">
                            <?php } else { ?>
                                <a href="<?= base_url() ?>"><img src="<?= base_url($web_logo) ?>"
                                        data-src="<?= base_url(rawurlencode($web_logo)) ?>" class="brand-logo-link"
                    ...
                    <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                        <div class="offcanvas-header d-lg-none">
                            ...
                            <?php } else { ?>
                                <a href="<?= base_url() ?>"><img src="<?= base_url(rawurlencode($web_logo)) ?>"
                                        data-src="<?= base_url(rawurlencode($web_logo)) ?>" class="brand-logo-link h-10"
                                        alt="site-logo image"></a>
                            <?php } ?>
                        ...
                        <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                            <ul class="navbar-nav">
                                ...
                                <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($current_url == base_url('sellers')) ? 'active' : '' ?>"
                                            href="<?= base_url('sellers') ?>"
                                            aria-label="sellers"><?= !empty($this->lang->line('sellers')) ? str_replace('\\', '', $this->lang->line('sellers')) : 'Sellers' ?></a>
                                    </li>
                                <?php } ?>

                                <li class="nav-item">
                                    <a class="nav-link <?= ($current_url == base_url('home/contact-us')) ? 'active' : '' ?>"
                                        href="<?= base_url('home/contact-us') ?>"
                                        aria-label="contact-us"><?= !empty($this->lang->line('contact_us')) ? str_replace('\\', '', $this->lang->line('contact_us')) : 'Contact Us' ?></a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link <?= ($current_url == base_url('home/faq')) ? 'active' : '' ?>"
                                        href="<?= base_url('home/faq') ?>"
                                        aria-label="faq"><?= !empty($this->lang->line('faq')) ? str_replace('\\', '', $this->lang->line('faq')) : 'FAQs' ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?= ($current_url == base_url('blogs/')) ? 'active' : '' ?>"
                    ...
                    <div class="navbar-other w-100 d-flex ms-auto position_rtl">
                        <ul class="navbar-nav flex-row align-items-center ms-auto ul_rtl">
                            ...
                            <?php if ($this->ion_auth->logged_in()) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('my-account/favorites') ?>" class="nav-link"
                            ...
                            <li class="nav-item d-flex flex-row align-items-center">
                                <a href="<?= base_url('compare') ?>" class="nav-link d-flex" onclick=display_compare()
                                    data-product-id="<?= ($row['id']) != 0 ? $row['id'] : '' ?>" aria-label="compare">
            ...
            <div class="offcanvas offcanvas-end bg-light" id="offcanvas-cart" data-bs-scroll="true" aria-modal="true"
                ...
                <div class="offcanvas-header">
                    <h3 class="mb-0">
                        <?= !empty($this->lang->line('shopping_cart')) ? str_replace('\\', '', $this->lang->line('shopping_cart')) : 'Shopping Cart' ?>
                    </h3>
                ...
                <div class="offcanvas-body d-flex flex-column px-3" id="cart-item-sidebar">
                    ...
                    if (isset($user->id)) {
                                ...
                                <div class="shopping-cart">
                                    <div class="shopping-cart-item d-flex justify-content-between mb-4">
                                            ...
                                            <figure class="rounded cart-img">
                                                <a href="<?= base_url('products/details/' . $items['product_slug']) ?>">
                                                    ...
                                                    if (isset($items['product_variants'][0]['images']) && !empty($items['product_variants'][0]['images']) && $items['product_variants'][0]['images'] != '[]' && $items['product_variants'][0]['images'] != []) {
                                                        ...
                                                        ?>
                                                        <img src="<?= base_url($variant_img[0]) ?>"
                                                            alt="<?= html_escape($items['name']) ?>"
                                                            title="<?= html_escape($items['name']) ?>" class="logo-fit">

                                                    <?php } else { ?>
                                                        <img src="<?= $items['image'] ?>" alt="<?= html_escape($items['name']) ?>"
                                                            title="<?= html_escape($items['name']) ?>" class="logo-fit">
                                                    <?php } ?>
                                                </a>
                                            </figure>
                                            <div class="w-100">
                                                ...
                                                <div class="product-pricing d-flex py-2 w-100">
                                                    <div class="product-quantity product-sm-quantity">
                                                        <input type="number" name="header_qty"
                                                            class="form-control d-flex align-content-center h-9 w-14 header_qty"
                                                            value="<?= $items['qty'] ?>"
                                        ...
                                        <div class="product-sm-removal">
                                            <button class="remove-product btn btn-sm btn-danger rounded-1 p-1 py-0"
                        ...
                        <?php } else { ?>
                            ...
                            <img src="<?= base_url('media/image?path=assets/front_end/modern/img/new/empty-cart(4).png&width=370&quality=80') ?>"
                ...
                <div class="offcanvas-footer flex-column text-center container">
                    ...
                    <?php if ((isset($user->id)) == 1) { ?>
                        <a href="<?= base_url('cart') ?>"
                            class="btn btn-primary btn-icon btn-icon-start rounded-pill mb-4 view_cart_button ms-6 mr-4">
