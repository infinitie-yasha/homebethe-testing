        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a
                        href="<?= base_url('products') ?>"><?= !empty($this->lang->line('product')) ? str_replace('\\', '', $this->lang->line('product')) : 'Products' ?></a>
                </li>
                <?php
                $cat_names = array();
                $cat_slugs = array();
        ...
        <div class="row mx-0">
                                    ...
                                    foreach ($variant_images as $image) {
                                        ...
                                        <div class="swiper-slide">
                                            <div class='product-view-grid'>
                                                <div class='product-view-image'>
                                                    <div class='product-view-image-container'>
                                                        <img src="<?= base_url('media/image?path=' . rawurlencode($image) . '&width=75&quality=80') ?>"
                                                            data-zoom-image="">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            foreach ($product['product'][0]['other_images_relative_path'] as $other_image) {
                                ...
                                <div class="swiper-slide">
                                    <div class='product-view-grid'>
                                        <div class='product-view-image'>
                                            <div class='product-view-image-container'>
                                                <img src="<?= base_url('media/image?path=' . rawurlencode($other_image) . '&width=620&quality=80') ?>"
                                                    id="img_01" data-zoom-image="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide ml-0">
                            <div class='product-view-grid'>
                                <div class='product-view-image'>
                                    <div class='product-view-image-container'>
                                        <img
                                            src="<?= base_url('media/image?path=' . rawurlencode($product['product'][0]['relative_path']) . '&width=175&quality=80') ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    foreach ($variant_images as $image) {
                                        ...
                                        <div class="swiper-slide">
                                            <div class='product-view-grid'>
                                                <div class='product-view-image'>
                                                    <div class='product-view-image-container'>
                                                        <img src="<?= base_url('media/image?path=' . rawurlencode($image) . '&width=175&quality=80') ?>"
                                                            data-zoom-image="">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="swiper-slide ml-0">
                                    <div class='product-view-grid'>
                                        <div class='product-view-image'>
                                            <div class='product-view-image-container'>
                                                <img
                                                    src="<?= base_url('media/image?path=' . rawurlencode($other_image) . '&width=172&quality=80') ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class=" swiper-container preview-image-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide text-center"><img
                                src="<?= base_url('media/image?path=' . rawurlencode($product['product'][0]['relative_path']) . '&width=300&quality=80') ?>">
                        </div>
                        <?php
                        if (!empty($product['product'][0]['other_images_relative_path']) && isset($product['product'][0]['other_images_relative_path'])) {
                            foreach ($product['product'][0]['other_images_relative_path'] as $other_image) { ?>
                                <div class="swiper-slide text-center">
                                    <img
                                        src="<?= base_url('media/image?path=' . rawurlencode($other_image) . '&width=300&quality=80') ?>">
                                </div>
                            <?php }
                        } ?>
                            ...
                            foreach ($variant_relative_path as $variant_images) {
                                if (!empty($variant_images)) {
                                    foreach ($variant_images as $image) {
                                        ?>
                                        <div class="swiper-slide text-center">
                                            <img src="<?= base_url('media/image?path=' . rawurlencode($image) . '&width=300&quality=80') ?>"
                                                data-zoom-image="">
                                        </div>
            ...
            <div class="col-12 col-md-6 product-page-details">
                                    ...
                                    foreach ($attribute_values as $key => $row) {
                                        if ($swatche_types[$key] == "1") {
                                            ...
                                            <label class="btn text-center fullCircle rounded-circle p-3" <?= $color_code ?>>
                                                <input type="radio" data-name="<?= trim($row) ?>" name="<?= $attribute['attr_name'] ?>"
                                                    value="<?= $attribute_ids[$key] ?>" autocomplete="off" class="attributes filter-input">
                                            </label>
                    ...
                    if ((isset($shiprocket_settings['pincode_wise_deliverability']) && $shiprocket_settings['pincode_wise_deliverability'] == 1) || (isset($shiprocket_settings['local_shipping_method']) && isset($shiprocket_settings['shiprocket_shipping_method']) && $shiprocket_settings['local_shipping_method'] == 1 && $shiprocket_settings['shiprocket_shipping_method'] == 1)) {
                        ...
                        <form class="mt-2" id="validate-zipcode-form" method="POST">
                            <div class="form-row">
                                ...
                                <button type="submit" class="button button-primary-outline" id="validate_zipcode"
                            ...
                            <div class="mt-2" id="error_box">
                                <?php if (!empty($product['product'][0]['zipcode'])) { ?>
                                    <b class="text-<?= ($product['product'][0]['is_deliverable']) ? "success" : "danger" ?>"><?= !empty($this->lang->line('product_is')) ? str_replace('\\', '', $this->lang->line('product_is')) : 'Product is' ?>
                    ...
                    if (isset($shiprocket_settings['city_wise_deliverability']) && $shiprocket_settings['city_wise_deliverability'] == 1 && $shiprocket_settings['shiprocket_shipping_method'] != 1) { ?>
                        <form class="mt-2" id="validate-city-form" method="POST">
                            <div class="form-row">
                                ...
                                <button type="submit" class="button button-primary-outline" id="validate_city"
                                    <?= ($this->ion_auth->logged_in()) ? '' : 'disabled' ?>><?= !empty($this->lang->line('check_availability')) ? str_replace('\\', '', $this->lang->line('check_availability')) : 'Check Availability' ?></button>
                            </div>
                            <div class="mt-2" id="error_box">
                                <?php if (!empty($product['product'][0]['zipcode'])) { ?>
                ...
                <div class="d-flex gap-2 overflow-auto">
                    <?php
                    // echo "<pre>";
                    // print_r($product['product'][0]['low_stock_limit']);
                    // die;
                    ...
                    <?php } else { ?>
                        <button type="button" name="add_cart" class="buttons btn-6-3 extra-small m-0 add_to_cart mt-1"
                            ...
                            data-product-low-stock-limit="<?= $product['product'][0]['low_stock_limit'] ?>"
                            data-seller-id="<?= $product['product'][0]['seller_id'] ?>"
                    ...
                    <?php } ?>
                    <button type="button" name="buy_now" class="buttons btn-6-5 extra-small m-0 buy_now mt-1"
                        id="buy_now" data-product-id="<?= $product['product'][0]['id'] ?>"
                        data-product-title="<?= $product['product'][0]['name'] ?>"
                        data-product-low-stock-limit="<?= $product['product'][0]['low_stock_limit'] ?>"
                        data-product-image="<?= $product['product'][0]['image'] ?>"
                        data-product-price="<?= ($variant['special_price'] > 0 && $variant['special_price'] != '0' && $variant['special_price'] != '') ? $variant['special_price'] : $variant['price']; ?>"
                        ...
                        <?= !empty($this->lang->line('buy_now')) ? str_replace('\\', '', $this->lang->line('buy_now')) : 'Buy Now' ?>
                    </button>
                    <button type="button" name="compare" class="buttons btn-6-6 extra-small m-0 mt-1 compare"
                        ...
                        <?= !empty($this->lang->line('compare')) ? str_replace('\\', '', $this->lang->line('compare')) : 'Compare' ?>
                    </button>
                    ...
                    if (isset($settings['whatsapp_status']) && $settings['whatsapp_status'] == 1 && isset($settings['whatsapp_number'])) { ?>
                        <a href="https://api.whatsapp.com/send?phone= <?= ($settings['whatsapp_number'] != '' && isset($settings['whatsapp_number'])) ? $settings['whatsapp_number'] : ((!defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['whatsapp_number']) - 3) . substr($settings['whatsapp_number'], -3) : $settings['whatsapp_number']) ?> &amp;text=Hello, I Seen This <?= $product['product'][0]['name'] ?> In Your Website And I Want to Buy This <?= base_url('products/details/' . $product['product'][0]['slug']) ?>"
                            target="_blank" title="Order From Whatsapp" class="buttons btn-6-4 extra-small m-0 mt-1">
                ...
                <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                    <div class="mt-2">
                        <?= !empty($this->lang->line('seller')) ? str_replace('\\', '', $this->lang->line('seller')) : 'Seller' ?>
                ...
                <?php if (isset($product['product'][0]['tags']) && !empty($product['product'][0]['tags'])) { ?>
                    ...
                    <div class="mt-3">
                        <span
                            class="product-details-title"><?= !empty($this->lang->line('product_details')) ? str_replace('\\', '', $this->lang->line('product_details')) : 'Product Details : ' ?>
                        </span>
                        <hr>
                        <table class="product-detail-tab">
                            ...
                            if (isset($product['product'][0]['made_in']) && !empty($product['product'][0]['made_in']) && $product['product'][0]['made_in'] != '') { ?>
                                <tr>
                                    <td class="col-sm-2">
                                        <?= !empty($this->lang->line('made_in')) ? str_replace('\\', '', $this->lang->line('made_in')) : 'Made In : ' ?>
                                    </td>
                            ...
                            if (isset($product['product'][0]['brand']) && !empty($product['product'][0]['brand']) && $product['product'][0]['brand'] != '') {
                                ...
                                if (isset($brand_img) && !empty($brand_img)) {
                                    ...
                                    <tr>
                                        <td class="col-sm-2">
                                            <?= !empty($this->lang->line('brand')) ? str_replace('\\', '', $this->lang->line('brand')) : 'Brand : ' ?>
                                        </td>
                                        <td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title">
                                    <?= !empty($this->lang->line('add_faq')) ? str_replace('\\', '', $this->lang->line('add_faq')) : 'Add FAQ' ?>
                                </h5>
                                ...
                                <form method="post" action='<?= base_url('products/add_faqs') ?>' id="add-faqs">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="question"
                                            placeholder="<?= !empty($this->lang->line('enter_your_question_here')) ? str_replace('\\', '', $this->lang->line('enter_your_question_here')) : 'Enter Your Question Here' ?>"
                                            name="question">
                                    </div>
                                    <button type="submit" class="btn btn-primary btn-sm" id="add-faqs" name="add-faqs"
                                        value="Save"><?= !empty($this->lang->line('add_faq')) ? str_replace('\\', '', $this->lang->line('add_faq')) : 'Add FAQ' ?></button>
                                    <div class="mt-3">
                    ...
                    <div class="nav nav-tabs" id="product-tab" role="tablist">
                        ...
                        <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                            <a class="nav-item nav-link product-nav-tab " id="product-seller-tab" data-toggle="tab"
                                href="#product-seller" role="tab" aria-controls="product-seller"
                        ...
                        if (!empty($review_images['total_images'])) {
                            if ($review_images['total_images'] > 0) { ?>
                                <h3 class="review-title">
                                    <?= !empty($this->lang->line('user_review_images')) ? str_replace('\\', '', $this->lang->line('user_review_images')) : 'User Review Images' ?>
                                    ...
                                    <div class="add-review">
                                        ...
                                        <form action="<?= $form_link ?>" id="product-rating-form" method="POST">
                                            ...
                                            <div class="rating-form">
                                                <label
                                                    for="rating"><?= !empty($this->lang->line('your_rating')) ? str_replace('\\', '', $this->lang->line('your_rating')) : 'Your rating' ?></label>
                            ...
                            <div class="product-grid">
                                ...
                                <div class="product-image">
                                    <div class="product-image-container">
                                        <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                            <img class="pic-1"
                                                src="<?= base_url('media/image?path=' . rawurlencode($row['relative_path']) . '&width=225&quality=80') ?>">
                                        </a>
                                    </div>
                                    <ul class="social">
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            ?>
                                            <a href=""
                                                data-tip="<?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add To Cart' ?>"
                                                class="add_to_cart" data-product-id="<?= $row['id'] ?>"
                                                data-product-stock="<?= $product_stock ?>"
                                                data-product-variant-id="<?= $variant_id ?>"
                                                data-product-title="<?= $row['name'] ?>"
                                                data-product-image="<?= $row['image'] ?>"
                                                data-seller-id="<?= $row['seller_id'] ?>"
                                                data-product-low-stock-limit="<?= $row['low_stock_limit'] ?>"
                                    ...
                                    <?php if (isset($row['min_max_price']['special_price']) && $row['min_max_price']['special_price'] != '' && $row['min_max_price']['special_price'] != 0 && $row['min_max_price']['special_price'] < $row['min_max_price']['min_price']) { ?>
                                        <span
                                            class="product-new-label"><?= !empty($this->lang->line('sale')) ? str_replace('\\', '', $this->lang->line('sale')) : 'Sale' ?>
                                            <?= $row['min_max_price']['discount_in_percentage'] ?>%</span>
                                ...
                                <div class="product-content">
                                    <h3 class="title title_wrap" title="<?= $row['name'] ?>">
                                        <a
                                            href="<?= base_url('products/details/' . $row['slug']) ?>"><?= str_replace('\r\n', '&#13;&#10;', strip_tags($row['name'])) ?></a>
                                    </h3>
                                    ...
                                    <a href="" class="add-to-cart add_to_cart" data-product-id="<?= $row['id'] ?>"
                                        ...
                                        <?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add To Cart' ?></a>
