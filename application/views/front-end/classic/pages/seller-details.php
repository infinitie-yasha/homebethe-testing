...
<section class="breadcrumb-title-bar colored-breadcrumb deeplink_wrapper">
    <div class="main-content responsive-breadcrumb">
        <h2><?= isset($page_main_bread_crumb) ? $page_main_bread_crumb : 'Products' ?><?= (isset($seller) && !empty($seller[0]['store_name'])) ? " By " . $seller[0]['store_name'] : '' ?>
        </h2>
        ...
        <div class="mx-0">
            <div class="pt-3 pb-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <ul class="d-flex gap-4 pl-0 flex-wrap">
                                        <li class="d-inline-block">
                                            ...
                                            <?= $sellers[0]['rating'] ?>
                                            <?= !empty($this->lang->line('ratings')) ? str_replace('\\', '', $this->lang->line('ratings')) : 'Ratings' ?>
                                        </li>
                                        <li class="d-inline-block">
                ...
                <div class="seller_card p-5 mt-5">
                    <h3>About Seller</h3>
                    <p><?= output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags((sanitize_store_description($sellers[0]['store_description']) ?? '')))) ?></p>
                </div>
                            ...
                            <div class="col-md-3 col-sm-6 mb-3">
                                <div class="product-grid">
                                    ...
                                    <div class="product-image">
                                        <div class="product-image-container">
                                            <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                                <img class="pic-1 lazy"
                                                    data-src="<?= base_url('media/image?path=' . rawurlencode($row['relative_path']) . '&width=320&quality=80') ?>">
                                            </a>
                                        </div>
                                        <ul class="social">
                                            <?php
                                            ...
                                            <li>
                                                ...
                                                <?php } else { ?>
                                                    <a href="" data-seller-id="<?= $row['seller_id'] ?>"
                                        ...
                                        <?php if (isset($row['min_max_price']['special_price']) && $row['min_max_price']['special_price'] != '' && $row['min_max_price']['special_price'] != 0 && $row['min_max_price']['special_price'] < $row['min_max_price']['min_price']) { ?>
                                            <span
                                                class="product-new-label"><?= !empty($this->lang->line('sale')) ? str_replace('\\', '', $this->lang->line('sale')) : 'Sale' ?></span>
                                            <span
                                    ...
                                    <div class="product-content">
                                        ...
                                        <?php } else { ?>
                                            <a class="add-to-cart add_to_cart" data-seller-id="<?= $row['seller_id'] ?>" href=""
                                                ...
                                                data-product-low-stock-limit="<?= $row['low_stock_limit'] ?>"
                                                data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>"
                                                data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['short_description'])))); ?>"
                                                data-izimodal-open="<?= $modal ?>">+
