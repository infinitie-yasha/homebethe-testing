        ...
        <div class="mx-0">
            <div class="pt-3 pb-3">
                ...
                <div class="seller_card p-5 mt-5">
                    <h3>About Seller</h3>
                    <p><?= output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($sellers[0]['store_description']))) ?></p>
                </div>
                            ...
                            <div class="col-md-3 col-sm-6 mb-3">
                                <div class="product-grid">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <ul class="social">
                                            ...
                                            <li>
                                                ...
                                                <?php } else { ?>
                                                    <a href="" data-seller-id="<?= $row['seller_id'] ?>" data-tip="<?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add To Cart' ?>" class="add_to_cart" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-stock= "<?= $product_stock ?>"  data-product-low-stock-limit="<?= $row['low_stock_limit'] ?>"  data-product-title="<?= $row['name'] ?>" data-product-image="<?= $row['image'] ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <?php } else { ?>
                                            <a class="add-to-cart add_to_cart"  data-seller-id="<?= $row['seller_id'] ?>"  href="" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-stock= "<?= $product_stock ?>" data-product-title="<?= $row['name'] ?>" data-product-image="<?= $row['image'] ?>" data-product-price="<?= $variant_price; ?>" data-product-low-stock-limit="<?= $row['low_stock_limit'] ?>"  data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">+ <?= !empty($this->lang->line('add_to_cart')) ? str_replace('\\', '', $this->lang->line('add_to_cart')) : 'Add To Cart' ?></a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
