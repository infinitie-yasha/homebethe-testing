...
<div id="mySidenav" class="sidenav is-closed-left">
    ...
    <input type="hidden" id="seller_low_stock_limit" name="seller_low_stock_limit"
        value='<?= isset($seller_data['low_stock_limit']) ? $seller_data['low_stock_limit'] : '10'; ?>'>
    <input type="hidden" id="allow_items_in_cart" name="allow_items_in_cart"
        value='<?= isset($settings['max_items_cart']) ? $settings['max_items_cart'] : '10'; ?>'>
    ...
    <input type="hidden" id="decimal_point" name="decimal_point"
        value='<?= isset($settings['decimal_point']) ? $settings['decimal_point'] : '2'; ?>'>
    ...
    <input type="hidden" name="app_name" id="app_name"
        value="<?= (isset($settings['app_name']) && !empty($settings['app_name'])) ? $settings['app_name'] : '' ?>">
    ...
    <div class="container">
        <div class="row my-2 pr-2 text-uppercase d-flex align-items-center">
            <div class="col-12 text-right close-sidenav"> <a href='#'
                    onclick="closeNav();"><?= !empty($this->lang->line('close')) ? str_replace('\\', '', $this->lang->line('close')) : 'Close' ?>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active show" data-toggle="tab"
                href="#Menu"><?= !empty($this->lang->line('menu')) ? str_replace('\\', '', $this->lang->line('menu')) : 'Menu' ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab"
                href="#Categories"><?= !empty($this->lang->line('category')) ? str_replace('\\', '', $this->lang->line('category')) : 'Category ' ?></a>
        </li>
    </ul>
    <!-- Tab panes -->
            ...
            <aside class="sidebar">
                <div id="leftside-navigation" class="nano">
                    <ul class="nano-content">
                        <li><a href="<?= base_url('products') ?>"><i class="fas fa-box-open fa-lg"></i>
                                <span><?= !empty($this->lang->line('shop')) ? str_replace('\\', '', $this->lang->line('shop')) : 'Shop' ?></span></a>
                        </li>

                        <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                            <li><a href="<?= base_url('seller/auth/sign_up') ?>" target="_blank"><i
                                        class="fas fa-user-plus fa-lg"></i><span
                                        class="ml-1"><?= !empty($this->lang->line('become_a_seller')) ? str_replace('\\', '', $this->lang->line('become_a_seller')) : 'Become a Seller' ?></a>
                            </li>
                        <?php } ?>


                        <?php if ($this->ion_auth->logged_in()) { ?>
                            <li><a href="<?= base_url('my-account/wallet') ?>"><i class="fa fa-wallet fa-lg"></i>
                                    <?= !empty($this->lang->line('balance')) ? str_replace('\\', '', $this->lang->line('balance')) : 'Balance' ?>
                                    <?= ' : ' . $settings['currency'] . ' ' . $user->balance ?></a></li>
                            <li><a href="<?= base_url('my-account') ?>"><i class="far fa-user-circle fa-lg"></i>
                                    <?= !empty($this->lang->line('my_account')) ? str_replace('\\', '', $this->lang->line('my_account')) : 'My Account' ?></a>
                            </li>
                            <li><a href="<?= base_url('my-account/orders') ?>"><i class="fa fa-history fa-lg"></i>
                                    <?= !empty($this->lang->line('my_orders')) ? str_replace('\\', '', $this->lang->line('my_orders')) : 'My Orders' ?></a>
                            </li>
                            <li><a href="<?= base_url('my-account/favorites') ?>"><i class="far fa-heart fa-lg"></i>
                                    <?= !empty($this->lang->line('favorite')) ? str_replace('\\', '', $this->lang->line('favorite')) : 'Favorite' ?></a>
                            </li>
                        <?php } else { ?>
                            <li><a href="" class="auth_model" data-izimodal-open=".auth-modal" data-value="login"><i
                                        class="fa fa-sign-in-alt fa-lg"></i>
                                    <?= !empty($this->lang->line('login')) ? str_replace('\\', '', $this->lang->line('login')) : 'Login' ?></a>
                            </li>
                            <li><a href="" class="auth_model" data-izimodal-open=".auth-modal" data-value="register"><i
                                        class="fa fa-user-check fa-lg"></i>
                                    <?= !empty($this->lang->line('register')) ? str_replace('\\', '', $this->lang->line('register')) : 'Register' ?></a>
                            </li>
                        <?php } ?>
                        <li><a href="<?= base_url('home/about-us') ?>"><i class="fa fa-info fa-lg"></i>
                                <span><?= !empty($this->lang->line('about_us')) ? str_replace('\\', '', $this->lang->line('about_us')) : 'About Us' ?></span></a>
                        </li>
                        <li><a href="<?= base_url('home/contact-us') ?>"><i class="fa fa-envelope fa-lg"></i>
                                <span><?= !empty($this->lang->line('contact_us')) ? str_replace('\\', '', $this->lang->line('contact_us')) : 'Contact Us' ?></span></a>
                        </li>
                        <li><a href="<?= base_url('home/faq') ?>"><i class="fas fa-question-circle fa-lg"></i><span
                                    class="ml-1"><?= label('faq', 'FAQs') ?></span></a></li>
                        <li><a href="<?= base_url('blogs/') ?>"><i class="fas fa-blog fa-lg"></i><span
                                    class="ml-1"><?= !empty($this->lang->line('blogs')) ? str_replace('\\', '', $this->lang->line('blogs')) : 'Blogs' ?></span></a>
                        </li>
                        <?php if ($this->ion_auth->logged_in()) { ?>
                            <li><a href="" id="logout_btn"><i class="fa fa-sign-out-alt fa-lg"></i>
                                    <?= !empty($this->lang->line('logout')) ? str_replace('\\', '', $this->lang->line('logout')) : 'Logout' ?></a>
                            </li>
                        <?php } ?>
                        <li class="sub-menu">
                            <a href="javascript:void(0);"><i class="fa fa-language fa-lg"></i>
                                <span><?= !empty($this->lang->line('language')) ? str_replace('\\', '', $this->lang->line('language')) : 'Language' ?></span><i
                                    class="arrow fa fa-angle-left float-right"></i></a>
                            <ul>
                ...
                <div id="leftside-navigation" class="nano mobile-categories">
                    <ul class="nano-content">
                        ...
                        <li class="see-all-category">
                            <a
                                href="<?= base_url('home/categories') ?>"><?= !empty($this->lang->line('see_all')) ? str_replace('\\', '', $this->lang->line('see_all')) : 'See All' ?></a>
                        </li>
                    </ul>
                </div>
            </aside>
...
<div class="shopping-cart-sidebar is-closed-right bg-white">
    ...
    <div class="container header ">
        <div class="row my-2 text-uppercase d-flex align-items-center">
            <div class="col-8 title">
                <h1><?= !empty($this->lang->line('shopping_cart')) ? str_replace('\\', '', $this->lang->line('shopping_cart')) : 'Shopping Cart' ?>
                </h1>
            </div>
            <div class="col-4 text-right close-sidebar"> <a href='#'
                    onclick="closeNav();"><?= !empty($this->lang->line('close')) ? str_replace('\\', '', $this->lang->line('close')) : 'Close' ?>
                    <i class="fa fa-times"></i></a></div>
        </div>
    </div>
    <hr class="m-0">
    <div class="text-center mt-2"><a class="button button-danger button-rounded" href="<?= base_url('products') ?>">
            <?= !empty($this->lang->line('return_to_shop')) ? str_replace('\\', '', $this->lang->line('return_to_shop')) : 'Return to Shop' ?></a>
    </div>
                    ...
                    <div class="row">
                        <div class="cart-product product-sm col-md-12">
                            <div class="product-image">
                                <img class="pic-1 lazy"
                                    data-src="<?= str_contains($items['image'], base_url()) ? $items['image'] : base_url($items['image']) ?>"
                            ...
                            <div class="product-pricing d-flex py-2 px-1 w-100">
                                ...
                                <div class="product-quantity product-sm-quantity px-1">
                                    <input type="number" name="header_qty" class="form-input" value="<?= $items['qty'] ?>"
                                        data-id="<?= $items['product_variant_id'] ?>" data-price="<?= $price ?>"
                                        min="<?= $items['minimum_order_quantity'] ?>" max="<?= $items['total_allowed_quantity'] ?>"
                                        step="<?= $items['quantity_step_size'] ?>">
                                </div>
                                <div class="product-sm-removal align-self-center">
                                    <button class="remove-product button button-danger"
                                        data-id="<?= $items['product_variant_id'] ?>">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                </div>
                                <div class="product-line-price align-self-center px-1">
                                    <?= $settings['currency'] . ' ' . number_format($items['qty'] * $price, 2) ?>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="text-center mt-2"><a class="button button-success button-rounded view_cart_button"
            href="<?= base_url('cart') ?>"><?= !empty($this->lang->line('view_cart')) ? str_replace('\\', '', $this->lang->line('view_cart')) : 'View Cart' ?></a>
    </div>
</div>
...
<header id="header" class="topper-white header-varient">
                    ...
                    <div class="topbar-left text-lg-left text-center">
                        <ul class="list-inline">
                            <?php if (isset($web_settings['support_number']) && !empty($web_settings['support_number'])) { ?>
                                <li><a href="tel:<?= $web_settings['support_number'] ?>"><i class="fa fa-phone-alt"></i>
                                        <?= $web_settings['support_number'] ?></a></li>
                            <?php } ?>
                            <?php if (isset($web_settings['support_email']) && !empty($web_settings['support_email'])) { ?>
                                <li><a href="mailto:<?= $web_settings['support_email'] ?>"> <i class="fa fa-envelope"></i>
                                        <?= $web_settings['support_email'] ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="topbar-right text-lg-right">
                        <ul class="list-inline">
                            <?php if (isset($web_settings['facebook_link']) && !empty($web_settings['facebook_link'])) { ?>
                                <li><a href="<?= $web_settings['facebook_link'] ?>" target="_blank"><i
                            ...
                            <li><a href="<?= base_url('home/contact-us') ?>"
                                    class="hide-sec"><?= !empty($this->lang->line('contact_us')) ? str_replace('\\', '', $this->lang->line('contact_us')) : 'CONTACT US' ?></a>
                            </li>
                            <li><a href="<?= base_url('home/faq') ?>"
                                    class="hide-sec"><?= !empty($this->lang->line('faq')) ? str_replace('\\', '', $this->lang->line('faq')) : 'FAQs' ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white main-content">
        ...
        <a class="navbar-brand" href="<?= base_url() ?>"><img src="<?= base_url($logo) ?>"
                data-src="<?= base_url($logo) ?>" class="brand-logo-link"></a>
            ...
            <div class="col-md-6">
                <form class="w-100">
                    <div class="input-group md-form form-sm form-2 pl-0 h-50 mx-auto navbar-top-search-box">
                        <!-- <input > -->
                        <select class="form-control my-0 py-1 p-2 rounded-0 search_product" type="text"
                ...
                <div class="navbar-nav">
                    <li class="nav-item dropdown active">
                        <a class="m-1" data-toggle="dropdown" href="#">
                            <?php if ($cookie_lang) { ?>
                                <span
                                    class="text-dark font-weight-bold"><?= ucfirst($language[$language_index]['code']) ?></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg">
                            <?php foreach ($language as $row) { ?>
                                <a href="<?= base_url('home/lang/' . strtolower($row['language'])) ?>"
                                    class="dropdown-item"><?= strtoupper($row['code']) . ' - ' . ucfirst($row['language']) ?></a>
                            <?php } ?>
                        </div>
                    </li>
                    <?php ?>
                        ...
                        <li class="nav-item dropdown active">
                            <a class="m-1" data-toggle="dropdown" href="#"><i class="fas fa-user fa-lg link-color"></i>
                                <span class="text-dark font-weight-bold">
                                    <?= (isset($user->username) && !empty($user->username)) ? "Hello " . $user->username : 'Login / Register' ?></span>
                                <i class="fas fa-angle-down link-color"></i>
                            </a>

                            <div class="dropdown-menu dropdown-menu-lg">
                                <a href="<?= base_url('my-account/wallet') ?>" class="dropdown-item"><i
                                        class="fas fa-wallet mr-2 text-primary link-color"></i>
                                    <?= $settings['currency'] . ' ' . isset($user->balance) && !empty($user->balance) ? number_format($user->balance, 2) : 0.0 ?></a>
                                <a href="<?= base_url('my-account') ?>" class="dropdown-item"><i
                                        class="fas fa-user mr-2 text-primary link-color"></i>
                                    <?= !empty($this->lang->line('profile')) ? str_replace('\\', '', $this->lang->line('profile')) : 'Profile' ?>
                                </a>
                                <a href="<?= base_url('my-account/orders') ?>" class="dropdown-item"><i
                                        class="fas fa-history mr-2 text-primary link-color"></i>
                                    <?= !empty($this->lang->line('orders')) ? str_replace('\\', '', $this->lang->line('orders')) : 'Orders' ?>
                                </a>
                                <a href="" class="dropdown-item" id="logout_btn"><i
                                        class="fa fa-sign-out-alt mr-2 text-primary link-color"></i><?= !empty($this->lang->line('logout')) ? str_replace('\\', '', $this->lang->line('logout')) : 'Logout' ?></a>
                            </div>
                        </li>

                    <?php } else { ?>
                        <li class="nav-item active"><a href="" class="m-2 auth_model" data-izimodal-open=".auth-modal"
                                data-value="login"><span
                                    class="text-dark font-weight-bold"><?= !empty($this->lang->line('login')) ? str_replace('\\', '', $this->lang->line('login')) : 'Login' ?></a>
                        </li>/
                        <li class="nav-item active"><a href="" class="m-2 auth_model" data-izimodal-open=".auth-modal"
                                data-value="register"><span
                                    class="text-dark font-weight-bold"><?= !empty($this->lang->line('register')) ? str_replace('\\', '', $this->lang->line('register')) : 'Register' ?></a>
                        </li>
                    <?php } ?>
                    ...
                    <li class="nav-item active">
                        <a href="<?= base_url('compare') ?>" class="p-2 header-icon" onclick=display_compare()
                            data-product-id="<?= ($row['id']) != 0 ? $row['id'] : '' ?>">
        ...
        <div class="main-content">
            <div class="row header-bottom-inner mx-0">
                <div class="column col-left">
                    <div
                        class="header-categories-nav <?= (current_url() == base_url() || current_url() == base_url('home')) ? 'show-menu' : 'show-menu' ?>">
                        <div class="header-categories-nav-wrap">
                            <span class="menu-opener">
                                <span class="burger-menu"><i class="fas fa-bars"></i></span>
                                <span
                                    class="menu-label"><?= !empty($this->lang->line('category')) ? str_replace('\\', '', $this->lang->line('category')) : 'Browse Categories' ?></span>
                                        ...
                                        foreach ($categories as $row) {
                                            ...
                                            <a href="<?= base_url('products/category/' . $row['slug']) ?>">
                                                <li class="category-span d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <span
                                                            class="category-line-height text-dark"><?= $row['name'] ?></span>
                                                    </div>
                                                </li>
                                            </a>
                                        <?php } ?>
                    ...
                    <div class="main-nav menu-left">
                        <div class="menu-main-navigation-container">
                            <div class="cd-morph-dropdown cd-dp">
                                <a href="#0"
                                    class="nav-trigger"><?= !empty($this->lang->line('open_nav')) ? str_replace('\\', '', $this->lang->line('open_nav')) : 'Open Nav' ?><span
                                ...
                                <nav class="main-nav">
                                    <ul>
                                        ...
                                        <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                                            <li class="morph-text">
                                                <a
                                                    href="<?= base_url('sellers') ?>"><?= !empty($this->lang->line('sellers')) ? str_replace('\\', '', $this->lang->line('sellers')) : 'Sellers' ?></a>
                                            </li>
                                        <?php } ?>
                                        <li class="morph-text">
                                            <a
                                                href="<?= base_url('home/contact-us') ?>"><?= !empty($this->lang->line('contact_us')) ? str_replace('\\', '', $this->lang->line('contact_us')) : 'Contact Us' ?></a>
                                        </li>
                                        <li class="morph-text">
                                            <a
                                                href="<?= base_url('home/about-us') ?>"><?= !empty($this->lang->line('about_us')) ? str_replace('\\', '', $this->lang->line('about_us')) : 'About Us' ?></a>
                                        </li>
                                        <li class="morph-text">
                                            <a
                                                href="<?= base_url('home/faq') ?>"><?= !empty($this->lang->line('faq')) ? str_replace('\\', '', $this->lang->line('faq')) : 'FAQs' ?></a>
                                        </li>
                                        <li class="morph-text">
                                            <a
                                                href="<?= base_url('blogs/') ?>"><?= !empty($this->lang->line('blogs')) ? str_replace('\\', '', $this->lang->line('blogs')) : 'Blogs' ?></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                ...
                <div class="column col-right d-md-flex d-none">
                    <?php if (isset($settings['single_seller_system']) && $settings['single_seller_system'] == '0') { ?>
                        <a href="<?= base_url('seller/auth/sign_up') ?>" target="_blank"
                            class="btn btn-primary"><?= !empty($this->lang->line('become_a_seller')) ? str_replace('\\', '', $this->lang->line('become_a_seller')) : 'Become a Seller' ?></a>
                    <?php } ?>
